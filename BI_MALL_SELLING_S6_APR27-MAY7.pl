...
A.Retail_Price As Retail_Price,Sum(A.Qty)As Qty,  Sum(A.Total_Retail_With_Vat) As Total_Retail_With_Vat,A.Cur_Inven As Cur_Inven  
	...
	Where Till_Code In ('069','071','073','074','076')
...
$to = 'ester.mendoza@metroretail.com.ph,ronnie.conde@metroretail.com.ph, april.agapito@metroretail.com.ph, rosemarie.saravia@metroretail.com.ph, rhoda.camporedondo@metroretail.com.ph, jay.aguilar@metroretail.com.ph';
