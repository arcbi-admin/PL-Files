...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Sales by Register (S4 as of 14-29 MAY 2015).xlsx");
...
A.Retail_Price As Retail_Price,Sum(A.Qty)As Qty,  Sum(A.Total_Retail_With_Vat) As Total_Retail_With_Vat,A.Cur_Inven As Cur_Inven  
	...
	As Total_Retail_With_Vat,  Soh.Stock_On_Hand As Cur_Inven,Soh.Av_Cost As Cost  
		...
		where trunc(SH.tran_datetime) between '14-MAY-15' and '29-MAY-15'
	...
	Where Till_Code In ('134','157','118','119','178','177','116','120','179','151','160','128') 
...
#$to = 'april.agapito@metrogaisano.com';
...
$subject = 'Sales by Register (S4 as of 14-29 MAY 2015 ) ';

$msgbody_file = 'message.txt';

$attachment_file = "Sales by Register (S4 as of 14-29 MAY 2015).xlsx";
