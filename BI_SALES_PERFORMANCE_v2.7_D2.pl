...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance (2102) - Summary (as of $as_of) v2.7.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance (2102) - Summary (as of } . $as_of . q{) v2.7.xlsx" pdf});
	$pdf_job_1->run(60);	
...
$worksheet->write($a-11, 2, "Daily Sales Performance (2102)", $bold1);
...
$to = 'maureen.pasion@metroretail.com.ph';
...
$subject = 'Daily Sales Performance (2102) as of ' . $as_of;

$msgbody_file = 'message_BI.txt';

$attachment_file_1 = "Daily Sales Performance (2102) - Summary (as of $as_of) v2.7.xlsx";
$attachment_file_2 = "Daily Sales Performance (2102) - Summary (as of $as_of) v2.7.pdf";
