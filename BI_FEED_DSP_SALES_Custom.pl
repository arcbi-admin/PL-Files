...
if ($test eq 1){
	...
	$job1->spawn( "cmd" , q{cmd /C "DSP_Jobs_Custom.pl pause"});
	$job1->run(25000);
...
#$to = 'rex.cabanilla@metrogaisano.com,marlou.escanilla@metrogaisano.com, joey.labrador@metrogaisano.com, edsel.gayo@metrogaisano.com, Dennis.Cuizon@metrogaisano.com, rex.cabanilla@metrogaisano.com,jeff.bubuli@metroretail.com.ph';
