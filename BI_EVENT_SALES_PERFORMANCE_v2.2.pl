...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Event Sales Performance - Summary (as of $as_of) v2.2.xlsx");
...
$table = 'bi_event_sales_perf_22.csv';
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_event_sales_perf_22.csv" or die "bi_event_sales_perf_22.csv: $!";
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_event_sales_perf_22.csv: $!";
