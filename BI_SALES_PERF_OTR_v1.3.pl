...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Outright (as of $as_of) v1.3.xlsx");
...
$attachment_file_1 = "Daily Sales Performance - Outright (as of $as_of) v1.3.xlsx";
