...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v1.5.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance - Summary (as of } . $as_of . q{) v1.5.xlsx" pdf});
	$pdf_job_1->run(60);	
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_15.csv" or die "bi_sales_perf_15.csv: $!";
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_15.csv: $!";
...
$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v1.5.xlsx";
$attachment_file_2 = "Daily Sales Performance - Summary (as of $as_of) v1.5.pdf";
