...
$worksheet->write($a-9, 2, "Event Sales Performance (Appliance Summer Sale 2015)", $bold1);
...
$worksheet->write($a-9, 3, "Event Sales Performance (Appliance Summer Sale 2015)", $bold1);
...
$sls = $dbh_csv->prepare (qq{SELECT SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly
								 ...
								 WHERE (((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
									...
									or store = '$store37' or store = '$store38' or store = '$store39' or store = '$store40')) and merch_group_code_rev <> 'Z_OT'
								});
$sls->execute();
...
#$to = ' karan.malani@metrogaisano.com, jordan.mok@metrogaisano.com  ';
...
# $to = 'rex.cabanilla@metrogaisano.com, annalyn.conde@metrogaisano.com, lea.gonzaga@metrogaisano.com, cham.burgos@metrogaisano.com, kent.mamalias@metrogaisano.com';

 $to = 'lea.gonzaga@metrogaisano.com';

$from = 'Report Mailer<report.mailer@metrogaisano.com>';
		
$subject = 'TEST SEND:Event Sales Performance (Appliance Summer Sale 2015) as of ' . $as_of;
...
# $cc = ' arthur.emmanuel@metrogaisano.com, frank.gaisano@metrogaisano.com, gerry.guanlao@metrogaisano.com, eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, rose.jose@metrogaisano.com, rex.cabanilla@metrogaisano.com, margaret.ang@metrogaisano.com, annalyn.conde@metrogaisano.com ';

# $bcc = ' kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, cham.burgos@metrogaisano.com, roel.gevana@metrogaisano.com ';
