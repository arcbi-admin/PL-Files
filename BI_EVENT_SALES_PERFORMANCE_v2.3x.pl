...
if ($test eq 1){
	...
	$event_st_date_key = 698; #OCT 17 2014
	$event_en_date_key = 698; #OCT 19 2014
	...
	$workbook = Excel::Writer::XLSX->new("Event Sales Performance - Summary (as of $as_of) v2.3x.xlsx");
	...
	&generate_csv; #version 1 will generate the aggregated data
...
$worksheet->write($a-9, 2, "Event Sales Performance (Krazyest Sale)", $bold1);
#$worksheet->write($a-8, 2, "Previous Day: $day_st_date_fld vs $day_st_date_fld_ly");
#$worksheet->write($a-8, 2, "Event-to-Date: $event_st_date_fld - $day_st_date_fld vs $event_st_date_fld_ly - $day_st_date_fld_ly");
$worksheet->write($a-8, 2, "Previous Day: $event_st_date_fld vs $event_st_date_fld_ly");
...
$worksheet->write($a-9, 3, "Event Sales Performance (Krazyest Sale)", $bold1);
#$worksheet->write($a-8, 3, "Previous Day: $day_st_date_fld vs $day_st_date_fld_ly");
#$worksheet->write($a-8, 3, "Event-to-Date: $event_st_date_fld - $day_st_date_fld vs $event_st_date_fld_ly - $day_st_date_fld_ly");
$worksheet->write($a-8, 3, "Previous Day: $event_st_date_fld vs $event_st_date_fld_ly");
...
$table = 'bi_event_sales_perf_23_test.csv';
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_event_sales_perf_23_test.csv" or die "bi_event_sales_perf_23_test.csv: $!";
...
BASE.STORE_CODE, 
CASE WHEN BASE.STORE_CODE IN ('2012', '2013', '3009', '4004', '3010', '3011', '2001W') THEN 'SU' || BASE.STORE_CODE 
...
FROM
	(SELECT STORE_FORMAT, STORE_FORMAT_DESC, STORE_CODE, STORE_DESCRIPTION, NEW_FLG, MATURED_FLG FROM DIM_STORE WHERE ACTIVE = 1 AND STORE_FORMAT IN (1, 2, 3, 4, 5) and STORE_CODE NOT IN (6008,6009,6012,3012))S,
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_event_sales_perf_23_test.csv: $!";
...
$to = ' chit.lazaro@metrogaisano.com, fili.mercado@metrogaisano.com, karan.malani@metrogaisano.com, joy.dizon@metrogaisano.com, julie.montano@metrogaisano.com, lia.chipeco@metrogaisano.com, marlita.portes@metrogaisano.com, jordan.mok@metrogaisano.com, peachy.aquino@metrogaisano.com, patricia.canton@metrogaisano.com, jennifer.yu@metrogaisano.com, jessica.gaisano@metrogaisano.com, april.agapito@metrogaisano.com, edna.prieto@metrogaisano.com, samantha.yen@metrogaisano.com, tessie.baldezamo@metrogaisano.com, delia.jakosalem@metrogaisano.com, jennifer.moreno@metrogaisano.com, may.sasedor@metrogaisano.com, alain.reyes@metrogaisano.com, dinah.ramirez@metrogaisano.com, jacqueline.cano@metrogaisano.com, joefrey.camu@metrogaisano.com, limuel.ulanday@metrogaisano.com, emily.silverio@metrogaisano.com, ernest.potgieter@metrogaisano.com, glenda.navares@metrogaisano.com, roy.igot@metrogaisano.com, luz.bitang@metrogaisano.com,gerry.guanlao@metrogaisano.com, eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, tricia.luntao@metrogaisano.com, jj.moreno@metrogaisano.com, cj.jesena@metrogaisano.com, rex.cabanilla@metrogaisano.com  ';

$bcc = 'kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, christopher.calalang@metrogaisano.com, annalyn.conde@metrogaisano.com, fnaquines@metro.com.ph, cham.burgos@metrogaisano.com, roel.gevana@metrogaisano.com ';
		
# $to = 'annalyn.conde@metrogaisano.com';
# $bcc = 'kent.mamalias@metrogaisano.com';
		
$subject = 'Event Sales Performance as of ' . $as_of;
$msgbody_file = 'message_BI.txt';

$attachment_file_1 = "Event Sales Performance - Summary (as of $as_of) v2.3x.xlsx";
