...
my $workbook = Excel::Writer::XLSX->new("Total In-stock v1.xlsx");
...
foreach $loc ( '2001', '2002', '2003', '2008', '2010', '2011', '2001W', '4003', '3009', '6001', '6003', '6005', '6010', '3001', '3002', '3003', '3004', '3005', '3006', '6004', '6008', '6009' ){
...
foreach $loc ( '2004', '2005', '2006', '2007', '2009', '2012', '2013', '2223', '3007', '3012', '4004', '6002', '6012','6013' ){
...
$worksheet->write($a-9, 3, "Total In-Stock", $bold1);
...
$loc1 = '2004', $loc2 = '2005', $loc3 = '2006', $loc4 = '2007', $loc5 = '2009', $loc6 = '2012', $loc7 = '2013', $loc8 = '2223', $loc9 = '3007', $loc10 = '4004', $loc11 = '6002', $loc12 = '6012', $loc13 = '3012', $loc14 = '6013', $loc15 = '0000', $loc16 = '0000', $loc17 = '0000', $loc18 = '0000', $loc19 = '0000', $loc21 = '0000', $loc22 = '0000', $loc23 = '0000', $loc24 = '0000', $loc25 = '0000', $loc26 = '0000', $loc27 = '0000', $loc28 = '0000', $loc29 = '0000', $loc30 = '0000', $loc31 = '0000', $loc32 = '0000', $loc33 = '0000', $loc34 = '0000', $loc35 = '0000', $loc36 = '0000', $loc37 = '0000', $region = 'Luzon Stores';
$a += 6, $counter  =0, $total_tot_items = 0, $total_rep_items = 0, $grp_tot_items = 0, $grp_rep_items = 0, $len = 0, $loc_pt = $a-2;
...
$stor1 = '0000'; $stor2 = '0000'; $stor3 = '0000'; $stor4 = '6004'; $stor5 = '0000'; $stor6 = '6012'; $stor7 = '6009'; $stor8 = '0000'; $stor9 = '6011'; $stor10 = '6013'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';   $stor14 = '0000';     $stor15 = '0000'; 
...
$worksheet->write(0, 2, "Total In-Stock - " . $comment , $bold);
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "instock_total_v1.csv" or die "instock_total_v1.csv: $!";
...
SUM(STK.ITEM_COUNT) TOT_REPL_ITEMS, 
SUM(STK.STOCK_TAG) REPL_WITH_SOH
FROM
	...
	LEFT JOIN
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(ITEM_COUNT) ITEM_COUNT, COUNT(STOCK_TAG) STOCK_TAG
	FROM(
		SELECT DISTINCT DEPS.GROUP_NO, MST.DEPT, DEPT_NAME, SOH.ITEM, SOH.LOC LOCATION, LOCATIONS.LOC_NAME, 'Y' AS ITEM_COUNT, 
		  SOH.STOCK_ON_HAND, CASE WHEN SOH.STOCK_ON_HAND <= 0 THEN NULL ELSE 'Y' END AS STOCK_TAG 
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "instock_total_v1.csv: $!";
...
#$to = ' cherry.gulloy@metrogaisano.com, janice.bedrijo@metrogaisano.com, jerson.roma@metrogaisano.com, bermon.alcantara@metrogaisano.com, eljie.laquinon@metrogaisano.com, nilynn.yosores@metrogaisano.com, ryanneil.dupay@metrogaisano.com, anafatima.mancho@metrogaisano.com ';

#$cc = 'annalyn.conde@metrogaisano.com, kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, fnaquines@metro.com.ph, cham.burgos@metrogaisano.com';
$cc = 'lea.gonzaga@metrogaisano.com';

$from = 'Report Mailer<report.mailer@metrogaisano.com>';

$subject = 'Total In-stock';

$msgbody_file = 'message.txt';

$attachment_file = "Total In-stock v1.xlsx";
