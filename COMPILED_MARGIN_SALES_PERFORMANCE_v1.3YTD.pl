...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("TOTAL MARGIN PERFORMANCE- 2014 Summary (as of $as_of) v1.3.xlsx");
...
$table = 'consolidated_margin_ytd.csv';
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "consolidated_margin_ytd.csv" or die "consolidated_margin_ytd.csv: $!";
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "consolidated_margin_ytd.csv: $!";
...
$subject = '2014 Sales and Margin Performance ' . $as_of;
$msgbody_file = 'message_margin.txt';

$attachment_file_1 = "TOTAL MARGIN PERFORMANCE- 2014 Summary (as of $as_of) v1.3.xlsx";
