...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("INSTOCK_REPORT_INTERNATIONAL.xlsx");
...
$test = qq{ 
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'China_HK_Taiwan' AS COUNTRY FROM
...
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'India' AS COUNTRY FROM
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO		
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Indonesia' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		FROM(
			...
			FROM REPL_ITEM_LOC REPL
				...
				LEFT JOIN (SELECT DISTINCT STORE LOC, STORE_NAME LOC_NAME FROM STORE UNION ALL SELECT DISTINCT WH AS LOC, WH_NAME LOC_NAME FROM WH)LOCATIONS ON REPL.LOCATION=LOCATIONS.LOC
			WHERE --LOC.STATUS IN ('A') AND  REPL.ACTIVATE_DATE <= SYSDATE AND (REPL.DEACTIVATE_DATE IS NULL OR REPL.DEACTIVATE_DATE > SYSDATE)
				REPL.ITEM IN ('6374266','9017380','9037761','9358796','9783398','9783399','9783401','9783403','9783405','9783452','9783457','9783647','10245373','10245404','10245409','10245413','10245434','10245440','10245446','10473232','10473234','10473236','10473238','10473240','10477062','10477064','10477065','10477066','10495318','10535465','10778308','10778310','101471545','101471577','101471584','101585533','101587133')
			)TBL
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Japan' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
...
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Korea' AS COUNTRY FROM
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Malaysia' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		FROM(
			...
			FROM REPL_ITEM_LOC REPL
				...
				LEFT JOIN (SELECT DISTINCT STORE LOC, STORE_NAME LOC_NAME FROM STORE UNION ALL SELECT DISTINCT WH AS LOC, WH_NAME LOC_NAME FROM WH)LOCATIONS ON REPL.LOCATION=LOCATIONS.LOC
			WHERE --LOC.STATUS IN ('A') AND  REPL.ACTIVATE_DATE <= SYSDATE AND (REPL.DEACTIVATE_DATE IS NULL OR REPL.DEACTIVATE_DATE > SYSDATE)
				REPL.ITEM IN ('5231133','8404909','9368846','10107282','10107296','10107299','10107301','10107303','10107311','10107314','10107316','10107317','10107321','10107323','10107329','10107340','10107345','10107350','10107363','10107366','10107369','10107373','10107382','10113292','10145380','10146100','10146101','10146164','10146186','10146195','10146210','10146220','10146223','10146244','10146254','10146256','10146257','10146260','10146264','10146271','10146286','10146294','10146297','10146299','10146311','10146329','10146335','10146337','10146338','10146339','10146343','10146346','10146354','10146370','10146392','10146446','10146460','10146486','10146490','10153498','10153508','10172488','10172491','10172492','10172495','10172505','10172512','10172513','10174697','10174699','10205691','10205827','10205829','10205836','10245339','10245418','10245423','10245439','10256522','10351089','10663604','10663605','10663607','10663609','10663612','10663614','10663616','10663618','10663620','10663622','10663624','10663648','10663649','10663650','15002435','101423440','101591713','101591845','101591856','101591865','101703373','101703381')
			)TBL
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Thailand' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		FROM(
			...
			FROM REPL_ITEM_LOC REPL
				...
				LEFT JOIN (SELECT DISTINCT STORE LOC, STORE_NAME LOC_NAME FROM STORE UNION ALL SELECT DISTINCT WH AS LOC, WH_NAME LOC_NAME FROM WH)LOCATIONS ON REPL.LOCATION=LOCATIONS.LOC
			WHERE --LOC.STATUS IN ('A') AND  REPL.ACTIVATE_DATE <= SYSDATE AND (REPL.DEACTIVATE_DATE IS NULL OR REPL.DEACTIVATE_DATE > SYSDATE)
				REPL.ITEM IN ('805071','805072','8312501','8432551','8846389','8846419','9017283','9152370','9175521','9191874','9191875','9191879','9191883','9228737','9228738','9228739','9228742','9228743','9271184','9271199','9271200','9271209','9285459','9285465','9285468','9285471','9334966','9334970','9334973','9334975','9334988','9334992','9362951','9363025','9363055','9363058','9363073','9363075','9363105','9363147','9363153','9363154','9363157','9447967','9466230','9534497','9566974','9566975','9566982','9566985','9566987','9575545','9575561','9575565','9575644','9583118','9583119','9589587','9589600','9589610','9589612','9589615','9589620','9589624','9589630','9589631','9589681','9589696','9604844','9639388','9639392','9639430','9639672','9639676','9639678','9639680','9667460','9671873','9702131','9702132','9783506','9783508','9783509','9783510','9783511','9783528','9783550','9783558','9783562','9783566','9783567','9783581','9783586','9783587','9783588','9798806','9798809','9798842','9805863','9809965','9809968','9809972','9811382','9812238','9856189','9883272','9883279','9883286','9883291','9884322','9884330','9949635','9949644','10029621','10062312','10062328','10062429','10062435','10062442','10084085','10084094','10107305','10114459','10114460','10124897','10124899','10124902','10124905','10124906','10124907','10124911','10124914','10124918','10124921','10124925','10124930','10124935','10124938','10124942','10124946','10124950','10146450','10168758','10168760','10168761','10168762','10168764','10168765','10186117','10186118','10186119','10186120','10186121','10186122','10197510','10200431','10200439','10200444','10200451','10204839','10205660','10205666','10205671','10205677','10205694','10205708','10205711','10205825','10205831','10205842','10245331','10245355','10245433','10245437','10245438','10245443','10245447','10251794','10251795','10251796','10251797','10251798','10251799','10251800','10251801','10251802','10251803','10251804','10270334','10270454','10270525','10270540','10270578','10270613','10350542','10350547','10350553','10350562','10350569','10350573','10350574','10350578','10350605','10350637','10350662','10350686','10350930','10364389','10364392','10364394','10364480','10364502','10364503','10364525','10364531','10364532','10364590','10364771','10364784','10442678','10443197','10443267','10443268','10443269','10443270','10443271','10443272','10450117','10450127','10450172','10450195','10450207','10450807','10450859','10450879','10450881','10450884','10450908','10510572','10510573','10510574','10510575','10510576','10510577','10520769','10520771','10520772','10520773','10520774','10520778','10529066','10555406','10555408','10555425','10555427','10555428','10555432','10555434','10555436','10555437','10556631','10556632','10556633','10556634','10556635','10556636','10556637','10556638','10556639','10556640','10556969','10556970','10556971','10556973','10556974','10556975','10556976','10556977','10622014','10622015','10622016','10622017','10633421','10633422','10633423','10633424','10633425','10633426','10667455','10667456','10667457','10720428','10720429','10720430','10720431','10733806','10733807','10733808','10733809','10733810','10733811','10733812','10733813','10733814','10733815','10733816','10733817','10733818','10733819','10733820','10733821','10733822','10733823','10733824','10733825','10733826','10733827','10750619','10750620','10754618','10754619','10754620','10754621','10754622','10754623','10763463','10763464','10763465','10763468','10763469','10763470','10763471','10763472','10772225','10772226','10772227','10788515','10794987','101443546','101443685','101443821','101449027','101449045','101449065','101449096','101449117','101449150','101452189','101460274','101460292','101460343','101460368','101460384','101467422','101471482','101480089','101480103','101483272','101483307','101483928','101483932','101483936','101559253','101569721','101569749','101569780','101569823','101569849','101570232','101585502','101585650','101585667','101585683','101585699','101585709','101586247','101590033','101591144','101591155','101593679','101593682','101593722','101593748','101593756','101593781','101593786','101593795','101593803','101594568','101594605','101644898','101644975','101645006','101645009','101645236','101645247','101645349','101645396','101645402','101645407','101645415','101645450','101645455','9818520','10555403','101703255','101703266','101713029','101713036','101713064','101713082','101713088','101713098','101713113','101713137','101713143','101713154','101731264','101731274','101731294','101731510','101731522','101731536','101731549','101731577','101731582','101731590','101745306','101765447')
			)TBL
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO		
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Vietnam' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		FROM(
			...
			FROM REPL_ITEM_LOC REPL
				...
				LEFT JOIN (SELECT DISTINCT STORE LOC, STORE_NAME LOC_NAME FROM STORE UNION ALL SELECT DISTINCT WH AS LOC, WH_NAME LOC_NAME FROM WH)LOCATIONS ON REPL.LOCATION=LOCATIONS.LOC
			WHERE --LOC.STATUS IN ('A') AND  REPL.ACTIVATE_DATE <= SYSDATE AND (REPL.DEACTIVATE_DATE IS NULL OR REPL.DEACTIVATE_DATE > SYSDATE)
				REPL.ITEM IN ('5806270','9126356','9126363','9126364','9326427','9327072','9409390','9529917','9529920','9624478','9624482','9624484','9702208','9847459','10068734','10073458','10166033','10166045','10166050','10166081','10166088','10166108','10166112','10245435','10245436','10245441','10350119','10350134','10473204','10473206','10473213','10473215','10473224','10473226','10473228','10473230','10688673','10688674','10688675','10688676','10688677','10763474','10763475','10763495','10763500','10763502','10763503','10763504','15000637','15000638','101568116','101568135','101568160','101568187','101568190','101578052','101578065','101578139','101578189','101578219','101578729','101578737','101585983','101636658','101647254')
			)TBL
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO
...
$attachment_file = 'INSTOCK_REPORT_INTERNATIONAL.xlsx';
