...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("TOTAL MARGIN PERFORMANCE (as of $as_of) v1.4.xlsx");
...
$grp_o_retail = 0, $grp_o_margin = 0, $grp_c_retail = 0, $grp_c_margin = 0, $grp_amt501000 = 0, $grp_amt432000 = 0, $grp_amt433000 = 0, $grp_amt458490 = 0, $grp_amt503200 = 0, $grp_amt503250 = 0, $grp_amt503500 = 0, $grp_amt506000 = 0, $grp_amt503000 = 0, $grp_amt507000 = 0, $grp_amt999998 = 0, $grp_amt505000 = 0, $grp_amt504000 = 0, $grp_amt434000 = 0, $grp_amt458550 = 0, $grp_amt460100 = 0, $grp_amt460200 = 0, $grp_amt460300;
...
$test = '
SELECT STORE_FORMAT, STORE_CODE, STORE, STORE_DESCRIPTION, MERCH_GROUP_CODE_REV, MERCH_GROUP_CODE, MERCH_GROUP_DESC, GROUP_CODE, GROUP_DESC, DIVISION, DIVISION_DESC, DEPARTMENT_CODE, DEPARTMENT_DESC, OTR_COST, OTR_RETAIL, OTR_MARGIN, CON_COST, CON_RETAIL, CON_MARGIN, AMOUNT501000, AMOUNT503200, AMOUNT503250, AMOUNT503500, AMOUNT506000, AMOUNT503000, AMOUNT507000, AMOUNT999998, AMOUNT505000, AMOUNT504000, AMOUNT432000, AMOUNT433000, AMOUNT458490, AMOUNT434000, AMOUNT458550, AMOUNT460100, AMOUNT460200, AMOUNT460300, NEW_FLG, MATURED_FLG FROM (
...
CASE WHEN SGD.STORE IN (\'2012\', \'2013\', \'3009\', \'4004\', \'3010\', \'3011\', \'3012\') THEN \'SU\' || SGD.STORE 	 WHEN SGD.STORE IN (\'4002\') THEN \'SU2001W\'     WHEN SGD.STORE = \'2223\' THEN \'DS\' || SGD.STORE	 ELSE SGD.MERCH_GROUP_CODE || SGD.STORE END,
SGD.STORE_NAME, 
...
SGD.GROUP_NO, 
SGD.GROUP_NAME,
CASE WHEN SGD.STORE IN (\'2009\',\'2012\',\'7176\',\'7003\',\'2006\',\'7004\',\'2007\',\'6008\',\'7005\',\'2010\',\'7300\',\'7009\',\'5006\',\'5005\',\'5004\',\'5003\',\'5002\',\'5001\',\'7173\',\'3004\',\'3003\',\'3001\',\'4003\',\'7008\',\'7007\',\'7006\',\'3006\',\'3007\',\'2003\',\'7000\',\'4002\',\'3005\',\'3002\',\'2002\',\'2001\',\'2011\',\'2008\',\'7001\',\'2004\',\'7002\',\'2005\', \'3012\', \'2013\', \'2223\', \'4004\', \'6001\', \'6002\', \'6003\', \'6005\', \'6010\') THEN 0 ELSE 1 END,
CASE WHEN SGD.STORE IN (\'2009\',\'2012\',\'7176\',\'7003\',\'2006\',\'7004\',\'2007\',\'6008\',\'7005\',\'2010\',\'7300\',\'7009\',\'5006\',\'5005\',\'5004\',\'5003\',\'5002\',\'5001\',\'7173\',\'3004\',\'3003\',\'3001\',\'4003\',\'7008\',\'7007\',\'7006\',\'3006\',\'3007\',\'2003\',\'7000\',\'4002\',\'3005\',\'3002\',\'2002\',\'2001\',\'2011\',\'2008\',\'7001\',\'2004\',\'7002\',\'2005\', \'3012\', \'2013\', \'2223\', \'4004\', \'6001\', \'6002\', \'6003\', \'6005\', \'6010\') THEN 1 ELSE 0 END
)
WHERE TEST_AMOUNT <> 0
ORDER BY 1, 3, 5, 7, 9';
...
# $to = ' kent.mamalias@metrogaisano.com, fnaquines@metro.com.ph'; #, lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, cham.burgos@metrogaisano.com, rex.cabanilla@metrogaisano.com 
...
$attachment_file_1 = "TOTAL MARGIN PERFORMANCE (as of $as_of) v1.4.xlsx";
