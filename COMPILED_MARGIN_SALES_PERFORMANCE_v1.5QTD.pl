...
#edited march 10 2014, added payable as source for COGS(50100, 50200)
...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("TOTAL MARGIN PERFORMANCE (as of $as_of) v1.5.xlsx");
...
$worksheet->write($a-8, 2, "QTD: 01 Jan 2015 - 31 Mar 2015");
...
$worksheet->write($a-9, 3, "QTD: 01 Jan 2015 - 31 Mar 2015");
...
$worksheet->write($a-8, 3, "QTD: 01 Jan 2015 - 31 Mar 2015");
...
FROM
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) OTR_UNITS, SUM(T.OTR_COST) OTR_COST, SUM(T.OTR_RETAIL) OTR_RETAIL, SUM((NVL(T.OTR_RETAIL,0))-(NVL(T.TOTAL_COST,0))) OTR_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST OTR_COST, TDH.TOTAL_RETAIL OTR_RETAIL, 
			...
			WHERE (TDH.TRAN_DATE BETWEEN \'01-JAN-15\' AND \'31-MAR-15\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 0)T
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) CON_UNITS, SUM(T.CON_COST) CON_COST, SUM(T.CON_RETAIL) CON_RETAIL, SUM((NVL(T.CON_RETAIL,0))-(NVL(T.TOTAL_COST,0))) CON_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST CON_COST, TDH.TOTAL_RETAIL CON_RETAIL, 
			...
			--FROM TRAN_DATA_HISTORY_BUP TDH 
				JOIN DEPS ON TDH.DEPT = DEPS.DEPT
			WHERE (TDH.TRAN_DATE BETWEEN \'01-JAN-15\' AND \'31-MAR-15\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 2)T
	...
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'501000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\') 
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503200\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503250\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503500\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'506000\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503000\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\') --AND MG.RMS_LOC_NO NOT IN (\'80061\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'507000\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\') --AND MG.RMS_LOC_NO NOT IN (\'80061\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'999998\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'505000\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'504000\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'432000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'433000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'458490\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'434000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'458550\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460100\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460200\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460300\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'502000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME IN (\'JAN-15\',\'FEB-15\',\'MAR-15\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' AND S.JE_SOURCE_NAME IN (\'Manual\',\'Payables\')
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
...
$to = ' frank.gaisano@metrogaisano.com, arthur.emmanuel@metrogaisano.com, gerry.guanlao@metrogaisano.com, eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, melissa.catan@metrogaisano.com, rex.cabanilla@metrogaisano.com, karan.malani@metrogaisano.com, lia.chipeco@metrogaisano.com, chit.lazaro@metrogaisano.com, fili.mercado@metrogaisano.com, margaret.ang@metrogaisano.com ';
