...
##mar 4 2014, dsp for cj jesena, pharma/f&b departments only
...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v2.6xx.xlsx");
	...
	# $pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance - Summary (as of } . $as_of . q{) v2.6xx.xlsx" pdf});
	# $pdf_job_1->run(60);	
	...
	# my $sth = $dbh_csv->prepare(qq{SELECT SUM(VALUE) AS AMOUNT FROM $table WHERE (GROUP_NO = '1510' OR GROUP_NO = '1520' OR GROUP_NO = '1530' OR GROUP_NO = '1540' OR GROUP_NO = '6010')});
...
$wtd_net_ly = 0, $mtd_net_ly = 0, $qtd_net_ly = 0, $wtd_target = 0, $mtd_target = 0, $qtd_target = 0;
&strComp_Ds;
&strComp_Su;
&strComp_Hy;
&strComp_Nb;
			...
			foreach my $col( 7, 8, 10, 12, 13, 15, 17, 18, 20 ){
				my $sumTY = '=SUM('.xl_rowcol_to_cell($comp_ds,$col).')';
					...
					if ($col eq 8 or $col eq 13 or $col eq 18){ 
						...
						if ($wtd_target eq 0 or $mtd_target eq 0 or $qtd_target eq 0) {
							$worksheet->write( $a, $col+1, "", $bodyPct );}
						else{
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col-3 ). '/' . xl_rowcol_to_cell( $a, $col ) . '-1' . ')';
							$worksheet->write( $a, $col+1, $pct2sls, $bodyPct ); } }
...
$sls1 = $dbh_csv->prepare (qq{SELECT merch_group_code_rev, merch_group_desc_rev,  SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
							  ...
							  WHERE ((new_flg = '$new_flg1' or new_flg = '$new_flg2') and (matured_flg = '$matured_flg1' or matured_flg = '$matured_flg2')) 
								and (division = '1500' or division = '6000')
...
while(my $s = $sls1->fetchrow_hashref()){
	...
	$sls2 = $dbh_csv->prepare (qq{SELECT group_code, group_desc, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
								 FROM $table 
								 WHERE merch_group_code_rev = '$merch_group_code' and ((new_flg = '$new_flg1' or new_flg = '$new_flg2') and (matured_flg = '$matured_flg1' or matured_flg = '$matured_flg2')) and (division = '1500' or division = '6000')
	...
	while(my $s = $sls2->fetchrow_hashref()){
		...
		$sls3 = $dbh_csv->prepare (qq{SELECT division, division_desc, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
									 FROM $table 
									 WHERE group_code = '$group_code' and merch_group_code_rev = '$merch_group_code' and ((new_flg = '$new_flg1' or new_flg = '$new_flg2') and (matured_flg = '$matured_flg1' or matured_flg = '$matured_flg2')) and (division = '1500' or division = '6000')
...
$sls1 = $dbh_csv->prepare (qq{SELECT store_code, store_description, merch_group_code_rev, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
							  FROM $table
							  WHERE store_code = '$store' and (division = '1500' or division = '6000')
...
while(my $s = $sls1->fetchrow_hashref()){
	...
	$sls2 = $dbh_csv->prepare (qq{SELECT group_code, group_desc, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
								 FROM $table 
								 WHERE merch_group_code_rev = '$merch_group_code' and store_code = '$store' and (division = '1500' or division = '6000')
								 GROUP BY group_code, group_desc
								 ORDER BY group_code
							 });	
	$sls2->execute();
	...
	while(my $s = $sls2->fetchrow_hashref()){
		...
		$sls3 = $dbh_csv->prepare (qq{SELECT division, division_desc, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
									 FROM $table 
									 WHERE group_code = '$group_code' and merch_group_code_rev = '$merch_group_code' and store_code = '$store' and (division = '1500' or division = '6000')
									 GROUP BY division, division_desc
									 ORDER BY division
									});
		$sls3->execute();
...
$sls = $dbh_csv->prepare (qq{SELECT SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
								 ...
								 WHERE (((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
									...
									or store = '$store37' or store = '$store38' or store = '$store39' or store = '$store40')) and merch_group_code_rev <> 'Z_OT' and (division = '1500' or division = '6000')
								});
$sls->execute();
...
while(my $s = $sls->fetchrow_hashref()){
	...
	$wtd_target += $s->{wtd_target};
	$mtd_target += $s->{mtd_target};
	$qtd_target += $s->{qtd_target};
...
if($type_test eq 3 or $type_test eq 4){
	...
	foreach my $col( 7, 8, 10, 12, 13, 15, 17, 18, 20 ){
		if($s1f2_row ne 0){
			...
			if ($col eq 8 or $col eq 13 or $col eq 18){
					if ($wtd_net_ly eq 0 or $mtd_net_ly eq 0 or $qtd_net_ly eq 0 or $wtd_target eq 0 or $mtd_target eq 0 or $qtd_target eq 0) {
						$worksheet->write( $a, $col+1, "", $bodyPct );}
					else{
						my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col-1 ). '/' . xl_rowcol_to_cell( $a, $col ) . '-1' . ')';
						$worksheet->write( $a, $col+1, $pct2sls, $bodyPct );}
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_26xx.csv" or die "bi_sales_perf_26xx.csv: $!";
...
TARGET_SALE_VAL, NET_SALE_TY, NET_SALE_LY, MTD_TARGET_SALE_VAL, MTD_NET_SALE_TY, MTD_NET_SALE_LY, QTD_TARGET_SALE_VAL, QTD_NET_SALE_TY, QTD_NET_SALE_LY 
FROM (
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_26xx.csv: $!";
...
$bcc = ' rex.cabanilla@metrogaisano.com, kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, cham.burgos@metrogaisano.com ';

$from = 'Report Mailer<report.mailer@metrogaisano.com>';

$subject = 'Daily Sales Performance as of ' . $as_of . '(Pharma and F & B Departments)';

$msgbody_file = 'message_BI.txt';

$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v2.6xx.xlsx";
...
my $sth = $dbh_csv->prepare(qq{SELECT STORE, STORE_NAME, MERCH_GROUP_CODE_REV, SUM(VALUE) VALUE 
								FROM $table 
								WHERE (GROUP_NO = '1510' OR GROUP_NO = '1520' OR GROUP_NO = '1530' OR GROUP_NO = '1540' OR GROUP_NO = '6010')
