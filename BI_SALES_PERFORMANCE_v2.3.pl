...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v2.3.xlsx");
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_2.csv" or die "bi_sales_perf_2.csv: $!";
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_2.csv: $!";
...
#$to = ' rex.cabanilla@metrogaisano.com, kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, christopher.calalang@metrogaisano.com, annalyn.conde@metrogaisano.com, fnaquines@metro.com.ph, cham.burgos@metrogaisano.com, roel.gevana@metrogaisano.com, rlegaspi@metro.com.ph ';
...
$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v2.3.xlsx";
...
$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v2.3.xlsx";
$attachment_file_2 = "Daily Sales Performance - Summary (as of $as_of) v2.3.pdf";
...
my $sth = $dbh_csv->prepare(qq{SELECT STORE, STORE_NAME, VALUE FROM $table});
