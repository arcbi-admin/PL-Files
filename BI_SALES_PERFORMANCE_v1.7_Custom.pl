...
if ($test eq 1){
	...
	SELECT WTD_ST_DT, WTD_ST_DT_LY, WTD_EN_DT, WTD_EN_DT_LY FROM
		(SELECT TO_CHAR(DATE_FLD, 'DD Mon YYYY') AS WTD_ST_DT, TO_CHAR(DATE_FLD_LY, 'DD Mon YYYY') AS WTD_ST_DT_LY 
			FROM DIM_DATE WHERE DATE_KEY = (SELECT WEEK_ST_DATE_KEY FROM DIM_DATE WHERE TRUNC(DATE_FLD) = TRUNC((SELECT DISTINCT UPDATE_DATE FROM METRO_IT_SALES_DEPT_WTD)-1))),
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v1.7.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance - Summary (as of } . $as_of . q{) v1.7.xlsx" pdf});
	$pdf_job_1->run(60);	
...
INSERT /*+ APPEND */ INTO METRO_IT_SALES_DEPT_WTD
...
#$to = ' arthur.emmanuel@metrogaisano.com, frank.gaisano@metrogaisano.com,eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, jj.moreno@metrogaisano.com, rose.jose@metrogaisano.com, rex.cabanilla@metrogaisano.com, margaret.ang@metrogaisano.com, aljim.jamandre@metrogaisano.com,arlene.valdez@metrogaisano.com';

$bcc = 'lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com,rashel.legaspi@metrogaisano.com,wendell.manumbaga@metrogaisano.com  ';

#$bcc = 'lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, cham.burgos@metrogaisano.com,rex.cabanilla@metrogaisano.com';
#$bcc = ' lea.gonzaga@metrogaisano.com,annalyn.conde@metrogaisano.com';
...
$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v1.7.xlsx";
$attachment_file_2 = "Daily Sales Performance - Summary (as of $as_of) v1.7.pdf";
