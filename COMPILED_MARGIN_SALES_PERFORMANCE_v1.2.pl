...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("CONSOLIDATED MARGIN - Summary (as of $as_of) v1.2.xlsx");
...
$worksheet->write($a-8, 3, "MTD: 01 Nov 2014 - 30 Nov 2014");
...
$worksheet->write($a-9, 3, "MTD: 01 Nov 2014 - 30 Nov 2014");
...
$worksheet->merge_range( $a-2, 40, $a-2, 42, 'NULL', $subhead );
$worksheet->merge_range( $a-2, 43, $a-2, 45, 'Invoice Price Variance - Trade', $subhead );
$worksheet->merge_range( $a-2, 46, $a-2, 48, 'Shrinkage Cost', $subhead );
$worksheet->merge_range( $a-2, 49, $a-2, 51, 'Cost Variance', $subhead );
$worksheet->merge_range( $a-2, 52, $a-2, 54, 'Synchronization Account', $subhead );
...
$worksheet->merge_range( $a-2, 64, $a-2, 66, 'Freight Recovery', $subhead );
...
$worksheet->merge_range( $a-2, 129, $a-2, 131, 'NULL', $subhead );
...
$worksheet->merge_range( $a-2, 153, $a-2, 155, 'Freight Recovery', $subhead );
...
while(my $s = $sls1->fetchrow_hashref()){
	...
	while(my $s = $sls2->fetchrow_hashref()){
		...
		while(my $s = $sls3->fetchrow_hashref()){
			...
			while(my $s = $sls4->fetchrow_hashref()){
				...
				$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$border1);
					if (($s->{o_retail}+$s->{c_retail}) le 0){
						$worksheet->write($a,9, "",$subt); }
					else{
						$worksheet->write($a,9, ($s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/($s->{o_retail}+$s->{c_retail}),$subt); }
				...
				$worksheet->write($a,15, $s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000},$border1);
					if ($s->{o_retail} le 0){
						$worksheet->write($a,16, "",$subt); }
					else{
						$worksheet->write($a,16, ($s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000})/$s->{o_retail},$subt); }
		...
		$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$bodyNum);
			if (($s->{o_retail}+$s->{c_retail}) le 0){
				$worksheet->write($a,9, "",$bodyPct); }
			else{
				$worksheet->write($a,9, ($s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/($s->{o_retail}+$s->{c_retail}),$bodyPct); }
		...
		$worksheet->write($a,15, $s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000},$bodyNum);
			if ($s->{o_retail} le 0){
				$worksheet->write($a,16, "",$bodyPct); }
			else{
				$worksheet->write($a,16, ($s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000})/$s->{o_retail},$bodyPct); }
	...
	if ($merch_group_code eq 'DS'){
		...
		$worksheet->write($a,8, $grp_o_margin+$grp_c_margin+$grp_amt501000+$grp_amt432000+$grp_amt433000+$grp_amt458490+$grp_amt503200+$grp_amt503250+$grp_amt503500+$grp_amt506000+$grp_amt503000+$grp_amt507000+$grp_amt999998+$grp_amt505000+$grp_amt434000+$grp_amt458550+$grp_amt460100+$grp_amt460200+$grp_amt460300,$headNum);
			if (($grp_o_retail+$grp_c_retail) le 0){
				$worksheet->write($a,9, "",$headDPct); }
			else{
				$worksheet->write($a,9, ($grp_o_margin+$grp_c_margin+$grp_amt501000+$grp_amt432000+$grp_amt433000+$grp_amt458490+$grp_amt503200+$grp_amt503250+$grp_amt503500+$grp_amt506000+$grp_amt503000+$grp_amt507000+$grp_amt999998+$grp_amt505000+$grp_amt434000+$grp_amt458550+$grp_amt460100+$grp_amt460200+$grp_amt460300)/($grp_o_retail+$grp_c_retail),$headDPct); }
		...
		$worksheet->write($a,15, $grp_o_margin+$grp_amt501000+$grp_amt432000+$grp_amt433000+$grp_amt458490+$grp_amt503200+$grp_amt503250+$grp_amt503500+$grp_amt506000+$grp_amt503000+$grp_amt507000+$grp_amt999998+$grp_amt505000,$headNum);
			if ($grp_o_retail le 0){
				$worksheet->write($a,16, "",$headDPct); }
			else{
				$worksheet->write($a,16, ($grp_o_margin+$grp_amt501000+$grp_amt432000+$grp_amt433000+$grp_amt458490+$grp_amt503200+$grp_amt503250+$grp_amt503500+$grp_amt506000+$grp_amt503000+$grp_amt507000+$grp_amt999998+$grp_amt505000)/$grp_o_retail,$headDPct); }
		...
		$worksheet->write($a,64, $grp_amt505000,$headNum);
	...
	$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$headNumber);
		if (($s->{o_retail}+$s->{c_retail}) le 0){
			$worksheet->write($a,9, "",$headPct); }
		else{
			$worksheet->write($a,9, ($s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/($s->{o_retail}+$s->{c_retail}),$headPct); }
	...
	$worksheet->write($a,15, $s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000},$headNumber);
		if ($s->{o_retail} le 0){
			$worksheet->write($a,16, "",$headPct); }
		else{
			$worksheet->write($a,16, ($s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000})/$s->{o_retail},$headPct); }
	...
	$worksheet->write($a,8, $total_o_margin+$total_c_margin+$total_amt501000+$total_amt432000+$total_amt433000+$total_amt458490+$total_amt503200+$total_amt503250+$total_amt503500+$total_amt506000+$total_amt503000+$total_amt507000+$total_amt999998+$total_amt505000+$total_amt434000+$total_amt458550+$total_amt460100+$total_amt460200+$total_amt460300,$headNumber);
			if (($total_o_retail+$total_c_retail) le 0){
				$worksheet->write($a,9, "",$headPct); }
			else{
				$worksheet->write($a,9, ($total_o_margin+$total_c_margin+$total_amt501000+$total_amt432000+$total_amt433000+$total_amt458490+$total_amt503200+$total_amt503250+$total_amt503500+$total_amt506000+$total_amt503000+$total_amt507000+$total_amt999998+$total_amt505000+$total_amt434000+$total_amt458550+$total_amt460100+$total_amt460200+$total_amt460300)/($total_o_retail+$total_c_retail),$headPct); }
	...
	$worksheet->write($a,15, $total_o_margin+$total_amt501000+$total_amt432000+$total_amt433000+$total_amt458490+$total_amt503200+$total_amt503250+$total_amt503500+$total_amt506000+$total_amt503000+$total_amt507000+$total_amt999998+$total_amt505000,$headNumber);
		if ($total_o_retail le 0){
			$worksheet->write($a,16, "",$headPct); }
		else{
			$worksheet->write($a,16, ($total_o_margin+$total_amt501000+$total_amt432000+$total_amt433000+$total_amt458490+$total_amt503200+$total_amt503250+$total_amt503500+$total_amt506000+$total_amt503000+$total_amt507000+$total_amt999998+$total_amt505000)/$total_o_retail,$headPct); }
	...
	$worksheet->write($a,43, $total_amt506000,$headNumber);
	$worksheet->write($a,44, "",$headNumber);
	$worksheet->write($a,45, "",$headNumber);
				
	$worksheet->write($a,46, $total_amt503000,$headNumber);
	$worksheet->write($a,47, "",$headNumber);
	$worksheet->write($a,48, "",$headNumber);
	
	$worksheet->write($a,49, $total_amt507000,$headNumber);
	$worksheet->write($a,50, "",$headNumber);
	$worksheet->write($a,51, "",$headNumber);
	
	$worksheet->write($a,52, $total_amt999998,$headNumber);
	$worksheet->write($a,53, "",$headNumber);
	$worksheet->write($a,54, "",$headNumber);
	...
	$worksheet->write($a,64, $total_amt505000,$headNumber);
	$worksheet->write($a,65, "",$headNumber);
	$worksheet->write($a,66, "",$headNumber);
...
while(my $s = $sls->fetchrow_hashref()){
		...
		$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$border1); # total margin
		...
		$worksheet->write($a,15, $s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000},$border1); #outright margin 
			if ($s->{o_retail} <= 0){
				$worksheet->write($a,16, "",$subt); }
			else{
				$worksheet->write($a,16, ($s->{o_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000})/$s->{o_retail},$subt); }
...
while(my $s = $sls->fetchrow_hashref()){
	...
	if($s1f2_counter eq 2){
		...
		$worksheet->write($a,8, $s1f2_o_margin+$s1f2_c_margin+$s1f2_amt501000+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt503200+$s1f2_amt503250+$s1f2_amt503500+$ss1f2_amt506000+$s1f2_amt503000+$s1f2_amt507000+$s1f2_amt999998+$s1f2_amt505000+$s1f2_amt434000+$s1f2_amt458550+$s1f2_amt460100+$s1f2_amt460200+$s1f2_amt460300,$border1);
			if (($s1f2_o_retail+$s1f2_c_retail) <= 0){
				$worksheet->write($a,9, "",$subt); }
			else{
				$worksheet->write($a,9, ($s1f2_o_margin+$s1f2_c_margin+$s1f2_amt501000+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt503200+$s1f2_amt503250+$s1f2_amt503500+$ss1f2_amt506000+$s1f2_amt503000+$s1f2_amt507000+$s1f2_amt999998+$s1f2_amt505000+$s1f2_amt434000+$s1f2_amt458550+$s1f2_amt460100+$s1f2_amt460200+$s1f2_amt460300)/($s1f2_o_retail+$s1f2_c_retail),$subt); }
		...
		$worksheet->write($a,15, $s1f2_o_margin+$s1f2_amt501000+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt503200+$s1f2_amt503250+$s1f2_amt503500+$ss1f2_amt506000+$s1f2_amt503000+$s1f2_amt507000+$s1f2_amt999998+$s1f2_amt505000,$border1);
			if ($s1f2_o_retail <= 0){
				$worksheet->write($a,16, "",$subt); }
			else{
				$worksheet->write($a,16, ($s1f2_o_margin+$s1f2_amt501000+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt503200+$s1f2_amt503250+$s1f2_amt503500+$ss1f2_amt506000+$s1f2_amt503000+$s1f2_amt507000+$s1f2_amt999998+$s1f2_amt505000)/$s1f2_o_retail,$subt); }
		...
		$worksheet->write($a,43, $s1f2_amt506000,$border1);
		$worksheet->write($a,44, "",$border1);
		$worksheet->write($a,45, "",$border1);
					
		$worksheet->write($a,46, $s1f2_amt503000,$border1);
		$worksheet->write($a,47, "",$border1);
		$worksheet->write($a,48, "",$border1);
		
		$worksheet->write($a,49, $s1f2_amt507000,$border1);
		$worksheet->write($a,50, "",$border1);
		$worksheet->write($a,51, "",$border1);
		
		$worksheet->write($a,52, $s1f2_amt999998,$border1);
		$worksheet->write($a,53, "",$border1);
		$worksheet->write($a,54, "",$border1);
		...
		$worksheet->write($a,64, $s1f2_amt505000,$border1);
		$worksheet->write($a,65, "",$border1);
		$worksheet->write($a,66, "",$border1);
...
if ($mrch1 eq 'DS' and $mrch2 eq 'DS' and $mrch3 eq 'OT' ){
	...
	while(my $s = $sls->fetchrow_hashref()){
		...
		$worksheet->write($a,97, $s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$border1); # total margin
			if (($s->{o_retail}+$s->{c_retail}) <= 0){
				$worksheet->write($a,98, "",$subt); }
			else{
				$worksheet->write($a,98, ($s->{o_margin}+$s->{c_margin}+$s->{amt501000}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt503200}+$s->{amt503250}+$s->{amt503500}+$s->{amt506000}+$s->{amt503000}+$s->{amt507000}+$s->{amt999998}+$s->{amt505000}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/($s->{o_retail}+$s->{c_retail}),$subt); }
...
if ($mrch1 eq 'DS' and $mrch2 eq 'DS' and $mrch3 eq 'OT' ){	
	...
	while(my $s = $sls->fetchrow_hashref()){
		...
		if($s1f2_counter eq 2){
			...
			$worksheet->write($a,104, $s1f2_o_margin+$s1f2_amt501000+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt503200+$s1f2_amt503250+$s1f2_amt503500+$ss1f2_amt506000+$s1f2_amt503000+$s1f2_amt507000+$s1f2_amt999998+$s1f2_amt505000,$border1);
				if ($s1f2_o_retail <= 0){
					$worksheet->write($a,105, "",$subt); }
				else{
					$worksheet->write($a,105, ($s1f2_o_margin+$s1f2_amt501000+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt503200+$s1f2_amt503250+$s1f2_amt503500+$ss1f2_amt506000+$s1f2_amt503000+$s1f2_amt507000+$s1f2_amt999998+$s1f2_amt505000)/$s1f2_o_retail,$subt); }
			...
			$worksheet->write($a,132, $s1f2_amt506000,$border1);
			$worksheet->write($a,133, "",$border1);
			$worksheet->write($a,134, "",$border1);
						
			$worksheet->write($a,135, $s1f2_amt503000,$border1);
			$worksheet->write($a,136, "",$border1);
			$worksheet->write($a,137, "",$border1);
			
			$worksheet->write($a,138, $s1f2_amt507000,$border1);
			$worksheet->write($a,139, "",$border1);
			$worksheet->write($a,140, "",$border1);
			
			$worksheet->write($a,141, $s1f2_amt999998,$border1);
			$worksheet->write($a,142, "",$border1);
			$worksheet->write($a,143, "",$border1);
			...
			$worksheet->write($a,153, $s1f2_amt505000,$border1);
			$worksheet->write($a,154, "",$border1);
			$worksheet->write($a,155, "",$border1);
...
FROM
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) OTR_UNITS, SUM(T.OTR_COST) OTR_COST, SUM(T.OTR_RETAIL) OTR_RETAIL, SUM((NVL(T.OTR_RETAIL,0))-(NVL(T.TOTAL_COST,0))) OTR_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST OTR_COST, TDH.TOTAL_RETAIL OTR_RETAIL, 
			...
			WHERE (TDH.TRAN_DATE BETWEEN \'01-NOV-14\' AND \'30-NOV-14\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 0)T
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) CON_UNITS, SUM(T.CON_COST) CON_COST, SUM(T.CON_RETAIL) CON_RETAIL, SUM((NVL(T.CON_RETAIL,0))-(NVL(T.TOTAL_COST,0))) CON_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST CON_COST, TDH.TOTAL_RETAIL CON_RETAIL, 
			...
			--FROM TRAN_DATA_HISTORY_BUP TDH 
				JOIN DEPS ON TDH.DEPT = DEPS.DEPT
			WHERE (TDH.TRAN_DATE BETWEEN \'01-NOV-14\' AND \'30-NOV-14\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 2)T
...
$attachment_file_1 = "CONSOLIDATED MARGIN - Summary (as of $as_of) v1.2.xlsx";
