...
if ($test eq 1){
	...
	$job1->spawn( "cmd" , q{cmd /C "COMPILED_MARGIN_SALES_PERFORMANCE_v1.7.pl pause"});
	$job1->run(25000);
...
CASE 
	...
	WHEN SGD.STORE IN (\'2005\', \'2008\', \'2010\', \'2011\', \'6001\', \'6002\', \'6003\', \'6004\', \'6005\', \'6012\', \'6009\', \'6010\', \'6011\',\'6006\',\'6013\') THEN \'4\'
...
CASE 
	...
	WHEN SGD.STORE IN (\'2005\', \'2008\', \'2010\', \'2011\', \'6001\', \'6002\', \'6003\', \'6004\', \'6005\', \'6012\', \'6009\', \'6010\', \'6011\',\'6006\',\'6013\') THEN \'Hypermarket\'
