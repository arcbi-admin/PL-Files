...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Concession (as of $as_of) v1.2.xlsx");
...
$worksheet->write($a-10, 2, "Daily Sales Performance - Concession", $bold1);
...
$worksheet->write($a-10, 3, "Daily Sales Performance - Concession", $bold1);
...
$table = 'bi_sales_perf_con_12.csv';
...
sub generate_csv_con {

my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_con_12.csv" or die "bi_sales_perf_con_12.csv: $!";
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_con_12.csv: $!";
...
$attachment_file_1 = "Daily Sales Performance - Concession (as of $as_of) v1.2.xlsx";
