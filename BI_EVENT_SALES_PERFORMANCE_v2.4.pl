...
if ($test eq 1){
	...
	# WHERE DATE_FLD = (SELECT TO_DATE(VALUE,'YYYY-MM-DD') FROM ADMIN_ETL_SUMMARY)
	 ...
	 $date = qq{ 
	SELECT WEEK_NUMBER_THIS_YEAR, DATE_KEY, TO_CHAR(DATE_FLD, 'DD Mon YYYY') DATE_FLD, DATE_KEY_LY, TO_CHAR(DATE_FLD_LY, 'DD Mon YYYY') DATE_FLD_LY, WEEK_ST_DATE_KEY, WEEK_END_DATE_KEY 
	FROM DIM_DATE
	...
	while (my $x = $sth_date_1->fetchrow_hashref()) {
		$day_st_date_key = $x->{DATE_KEY};
		$day_st_date_key_ly = $x->{DATE_KEY_LY};
		$day_st_date_fld = $x->{DATE_FLD};
		$day_st_date_fld_ly = $x->{DATE_FLD_LY};
		$as_of = $x->{DATE_FLD};
	}
	
	$event_st_date_key = 1173; #18-Mar-16: Sidewalk Sale
	$event_en_date_key = 1175; #28-Nov-15: Crazy Sale
		
	$date_2 = qq{ 
	SELECT DATE_KEY1, TO_CHAR(DATE_FLD1, 'DD Mon YYYY') DATE_FLD1, DATE_KEY_LY1, TO_CHAR(DATE_FLD_LY1, 'DD Mon YYYY') DATE_FLD_LY1, DATE_KEY2, TO_CHAR(DATE_FLD2, 'DD Mon YYYY') DATE_FLD2, DATE_KEY_LY2, TO_CHAR(DATE_FLD_LY2, 'DD Mon YYYY') DATE_FLD_LY2, TO_CHAR(DATE_FLD_WTD_GREG, 'DD Mon YYYY') DATE_FLD_WTD_GREG_LY FROM
		(SELECT DATE_KEY AS DATE_KEY1, DATE_FLD AS DATE_FLD1, DATE_KEY_LY AS DATE_KEY_LY1, DATE_FLD_LY AS DATE_FLD_LY1
		FROM DIM_DATE WHERE DATE_KEY = $event_st_date_key),
		(SELECT DATE_KEY AS DATE_KEY2, DATE_FLD AS DATE_FLD2, DATE_KEY_LY AS DATE_KEY_LY2, DATE_FLD_LY AS DATE_FLD_LY2
		FROM DIM_DATE WHERE DATE_KEY = $event_en_date_key),
	...
	while (my $x = $sth_date_2->fetchrow_hashref()) {
		$event_st_date_key = $x->{DATE_KEY1};
		$event_st_date_fld = $x->{DATE_FLD1};	
		#$event_st_date_key_ly = $x->{DATE_KEY_LY1};
		#$event_st_date_fld_ly = $x->{DATE_FLD_LY1};
		$event_st_date_key_ly = 802;
		$event_st_date_fld_ly = '13 Mar 2015';
		
		$event_en_date_key = $x->{DATE_KEY2};
		$event_en_date_fld = $x->{DATE_FLD2};
		
		#$event_en_date_key_ly = $x->{DATE_KEY_LY2};
		#$event_en_date_fld_ly = $x->{DATE_FLD_LY2};
		
		$event_en_date_key_ly = 802;
		$event_en_date_fld_ly = '13 Mar 2015';
		
		#NOTE: GABZ: enable on Saturday(19-Mar-16) and disable above (802 and 13-Mar-15)
		#$event_en_date_key_ly = 803;
		#$event_en_date_fld_ly = '14 Mar 2015';
		
		#NOTE: ROM enable on Sunday(20-Mar-16) and disable above (803 and 14-Mar-15)
	    #$event_en_date_key_ly = 804;
		#$event_en_date_fld_ly = '15 Mar 2015';
	}
	
	#=============================== GROUP 1=================================================# 
 
	$workbook = Excel::Writer::XLSX->new("Event Sales Performance - Summary (as of $as_of) v2.4.xlsx");
...
$a = 10, $e = 10, $counter = 0, $total_wtd_net_ty = 0, $total_wtd_net_ly = 0, $total_wtd_target = 0, $total_mtd_net_ty = 0, $total_mtd_net_ly = 0 , $total_mtd_target = 0, $grp_wtd_net_ty = 0, $grp_wtd_net_ly = 0, $grp_wtd_target = 0, $grp_mtd_net_ty = 0, $grp_mtd_net_ly = 0 , $grp_mtd_target = 0, $type_test = 0;

$worksheet->write($a-9, 2, "Event Sales Performance (SIDEWALK SALE)", $bold1);
#$worksheet->write($a-8, 2, "Previous Day: $day_st_date_fld vs $day_st_date_fld_ly");
$worksheet->write($a-7, 2, "Event-to-Date: $event_st_date_fld - $event_en_date_fld vs $event_st_date_fld_ly - $event_en_date_fld_ly");
...
$a += 7, $total_wtd_net_ty = 0, $total_wtd_net_ly = 0, $total_wtd_target = 0, $total_mtd_net_ty = 0, $total_mtd_net_ly = 0 , $total_mtd_target = 0, $grp_wtd_net_ty = 0, $grp_wtd_net_ly = 0, $grp_wtd_target = 0, $grp_mtd_net_ty = 0, $grp_mtd_net_ly = 0 , $grp_mtd_target = 0, $type_test = 0;
...
foreach my $i ( '2001', '2001W', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2223', '3001', '3002', '3003', '3004', '3005', '3006', '3007', '3009', '3010', '3012', '4003', '4004', '6001', '6002', '6003', '6004', '6005', '6009', '6010', '6012','6013','6011' ){ 
...
$worksheet->write($a-9, 3, "Event Sales Performance (SIDEWALK SALE)", $bold1);
#$worksheet->write($a-8, 3, "Previous Day: $day_st_date_fld vs $day_st_date_fld_ly");
$worksheet->write($a-7, 3, "Event-to-Date: $event_st_date_fld - $event_en_date_fld vs $event_st_date_fld_ly - $event_en_date_fld_ly");
...
$store41 = '0000'; $store42 = '0000'; $store43 = '0000';

$stor1 = '0000'; $stor2 = '0000'; $stor3 = '3009'; $stor4 = '3010'; $stor5 = '3011'; $stor6 = '3012'; $stor7 = '0000'; $stor8 = '0000'; $stor9 = '0000'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';   $stor14 = '0000'; 
		...
		$tst = $a; $comp_nb=$a; $a+=1; $b+=1; $d=$a; $counter = 0; #ADD 1 TO VARIABLES A RESET COUNTER
			...
			foreach my $col( 7, 8, 10){
				my $sumTY = '=SUM('.xl_rowcol_to_cell($comp_nb,$col).')';
					...
					if ($col eq 10){
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col-3 ). '/' . xl_rowcol_to_cell( $a, $col ) . ')';
							$worksheet->write( $a, $col+1, $pct2sls, $bodyPct ); }
			}
...
$stor1 = '3012'; $stor2 = '0000'; $stor3 = '0000'; $stor4 = '0000'; $stor5 = '0000'; $stor6 = '0000'; $stor7 = '0000'; $stor8 = '0000'; $stor9 = '0000'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';   $stor14 = '0000';  
	...
	if($type_test eq 1){	
		...
		$tst = $a; $new_nb=$a; $a+=1; $b+=1; $d=$a; $counter = 0; #ADD 1 TO VARIABLES A RESET COUNTER
...
#$fmt1 = 1; $fmt2 = 2; $fmt3 = 3; $fmt4 = 4; $fmt5 = 5;
$store1 = '0000'; $store2 = '0000'; $store3 = '0000'; $store4 = 'SU6004'; $store5 = 'SU6013'; $store6 = 'SU6012'; $store7 = 'SU6009'; $store8 = '0000'; $store9 = 'SU6011'; $store10 = '0000'; $store11 = '0000'; $store12 = '0000'; $store13 = 'DS6004'; $store14 = 'DS6013'; $store15 = 'DS6012'; $store16 = 'DS6009'; $store17 = '0000'; $store18 = 'DS6011'; $store19 = '0000'; $store20 = '0000'; $store21 = 'OT6004'; $store22 = '0000'; $store23 = 'OT6012'; $store24 = 'OT6009'; $store25 = '0000'; $store26 = 'OT6011';  $store27 = '0000'; $store28 = '0000'; $store29 = '0000'; $store30 = '0000'; $store31 = '0000'; $store32 = '0000'; $store33 = '0000'; $store34 = '0000'; $store35 = '0000'; $store36 = '0000'; $store37 = '0000'; $store38 = '0000'; $store39 = '0000'; $store40 = '0000'; $store41 = '0000'; $store42 = '0000'; $store43 = '0000';

$stor1 = '0000'; $stor2 = '0000'; $stor3 = '0000'; $stor4 = '6004'; $stor5 = '0000'; $stor6 = '6012'; $stor7 = '6009'; $stor8 = '6013'; $stor9 = '6011'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';   $stor14 = '0000';   $stor15 = '0000'; 
...
$stor1 = '2001'; $stor2 = '2002'; $stor3 = '2003'; $stor4 = '2004'; $stor5 = '2006'; $stor6 = '2007'; $stor7 = '2009'; $stor8 = '2223'; $stor9 = '0000'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';    $stor14 = '0000'; 
	...
	if($type_test eq 1){	&query_summary;	} 
		...
		$tst = $a-$counter; $comp_ds=$a; $a+=1; $b+=1; $d=$a; $counter = 0; #ADD 1 TO VARIABLES A RESET COUNTER
...
$worksheet->conditional_formatting( 'F9:Y6000',  { type => 'cell', criteria => '<', value => 0, format => $down } );
...
$worksheet->merge_range( $a-2, 7, $a-2, 11, 'Event-to-Date', $subhead );
#$worksheet->merge_range( $a-2, 12, $a-2, 16, 'Event-to-Date', $subhead );
...
$worksheet->write($a-3, 3, "in 000's", $script);
$worksheet->merge_range( $a-2, 7, $a-2, 16, 'Event-to-Date', $subhead );
#$worksheet->merge_range( $a-2, 17, $a-2, 26, 'Event-to-Date', $subhead );
...
$table = 'bi_event_sales_perf_23.csv';
...
while(my $s = $sls1->fetchrow_hashref()){
	...
	while(my $s = $sls2->fetchrow_hashref()){
		...
		while(my $s = $sls3->fetchrow_hashref()){
			...
			while(my $s = $sls4->fetchrow_hashref()){
				...
				#else{
				#	$worksheet->write($a,11, ($s->{wtd_net_ty})/$s->{wtd_target},$subt); }
					
				$worksheet->write($a,7, $s->{mtd_net_ty},$border1);
				$worksheet->write($a,8, $s->{mtd_net_ly},$border1);
				$worksheet->write($a,10, $s->{mtd_target},$border1);
				if ($s->{mtd_net_ly} <= 0){
					$worksheet->write($a,9, "",$subt); }
				else{
					$worksheet->write($a,9, ($s->{mtd_net_ty}-$s->{mtd_net_ly})/$s->{mtd_net_ly},$subt); }
				
				if ($s->{mtd_net_ty} <= 0 or $s->{mtd_target} <= 0 ){
					$worksheet->write($a,11, "",$subt); }
				else{
					$worksheet->write($a,11, ($s->{mtd_net_ty})/$s->{mtd_target},$subt); }
			...
			#	else{
			#		$worksheet->write($a,11, ($s->{wtd_net_ty})/$s->{wtd_target},$bodyPct); }
					
			$worksheet->write($a,7, $s->{mtd_net_ty},$bodyNum);
			$worksheet->write($a,8, $s->{mtd_net_ly},$bodyNum);
			$worksheet->write($a,10, $s->{mtd_target},$bodyNum);
				if ($s->{mtd_net_ly} <= 0){
					$worksheet->write($a,9, "",$bodyPct); }
				else{
					$worksheet->write($a,9, ($s->{mtd_net_ty}-$s->{mtd_net_ly})/$s->{mtd_net_ly},$bodyPct); }
				
				if ($s->{mtd_net_ty} <= 0 or $s->{mtd_target} <= 0 ){
					$worksheet->write($a,11, "",$bodyPct); }
				else{
					$worksheet->write($a,11, ($s->{mtd_net_ty})/$s->{mtd_target},$bodyPct); }
	...
	if ($merch_group_code eq 'DS'){
		...
		#	else{
		#		$worksheet->write($a,11, ($grp_wtd_net_ty)/$grp_wtd_target,$headDPct); }
		
		$worksheet->write($a,7, $grp_mtd_net_ty,$headNum);
		$worksheet->write($a,8, $grp_mtd_net_ly,$headNum);
		$worksheet->write($a,10, $grp_mtd_target,$headNum);
			if ($grp_mtd_net_ly <= 0){
				$worksheet->write($a,9, "",$headDPct); }
			else{
				$worksheet->write($a,9, ($grp_mtd_net_ty-$grp_mtd_net_ly)/$grp_mtd_net_ly,$headDPct); }
				
			if ($grp_mtd_net_ty <= 0 or $grp_mtd_target <= 0 ){
				$worksheet->write($a,11, "",$headPct); }
			else{
				$worksheet->write($a,11, ($grp_mtd_net_ty)/$grp_mtd_target,$headDPct); }
	...
	#		$worksheet->write($a,11, "",$headPct); }
	#	else{
	#		$worksheet->write($a,11, ($s->{wtd_net_ty})/$s->{wtd_target},$headPct); }
	
	$worksheet->write($a,7, $s->{mtd_net_ty},$headNumber);
	$worksheet->write($a,8, $s->{mtd_net_ly},$headNumber);
	$worksheet->write($a,10, $s->{mtd_target},$headNumber);
		if ($s->{mtd_net_ly} <= 0){
			$worksheet->write($a,9, "",$headPct); }
		else{
			$worksheet->write($a,9, ($s->{mtd_net_ty}-$s->{mtd_net_ly})/$s->{mtd_net_ly},$headPct); }
			
		if ($s->{mtd_net_ty} <= 0 or $s->{mtd_target} <= 0 ){
			$worksheet->write($a,11, "",$headPct); }
		else{
			$worksheet->write($a,11, ($s->{mtd_net_ty})/$s->{mtd_target},$headPct); }
	...
	#		$worksheet->write($a,11, "",$headPct); }
	#	else{
	#		$worksheet->write($a,11, ($total_wtd_net_ty)/$total_wtd_target,$headPct); }
	
	$worksheet->write($a,7, $total_mtd_net_ty,$headNumber);
	$worksheet->write($a,8, $total_mtd_net_ly,$headNumber);
	$worksheet->write($a,10, $total_mtd_target,$headNumber);
		if ($total_mtd_net_ly <= 0){
			$worksheet->write($a,9, "",$headPct); }
		else{
			$worksheet->write($a,9, ($total_mtd_net_ty-$total_mtd_net_ly)/$total_mtd_net_ly,$headPct); }
			
		if ($total_mtd_net_ty <= 0 or $total_mtd_target <= 0 ){
			$worksheet->write($a,11, "",$headPct); }
		else{
			$worksheet->write($a,11, ($total_mtd_net_ty)/$total_mtd_target,$headPct); }
...
$sls1 = $dbh_csv->prepare (qq{SELECT store_code, store_description, merch_group_code_rev, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly
							  FROM $table
...
while(my $s = $sls1->fetchrow_hashref()){
	...
	if ($merch_group_code eq 'DS'){
		...
		#		$worksheet->write($a,11, "",$headPct); }
		#	else{
		#		$worksheet->write($a,11, ($grp_wtd_net_ty)/$grp_wtd_target,$headPct); }
		
		$worksheet->write($a,7, $grp_mtd_net_ty,$headNumber);
		$worksheet->write($a,8, $grp_mtd_net_ly,$headNumber);
		$worksheet->write($a,10, $grp_mtd_target,$headNumber);
			if ($grp_mtd_net_ly <= 0){
				$worksheet->write($a,9, "",$headPct); }
			else{
				$worksheet->write($a,9, ($grp_mtd_net_ty-$grp_mtd_net_ly)/$grp_mtd_net_ly,$headPct); }
				
			if ($grp_mtd_net_ty <= 0 or $grp_mtd_target <= 0 ){
				$worksheet->write($a,11, "",$headPct); }
			else{
				$worksheet->write($a,11, ($grp_mtd_net_ty)/$grp_mtd_target,$headPct); }
...
$sls = $dbh_csv->prepare (qq{SELECT SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly
								 ...
								 WHERE (((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
									...
									or store = '$store37' or store = '$store38' or store = '$store39' or store = '$store40' or store = '$store41' or store = '$store42' or store = '$store43' )) and merch_group_code_rev <> 'Z_OT'
								});
$sls->execute();
...
while(my $s = $sls->fetchrow_hashref()){
	...
	if($s1f2_counter eq 2){
		...
		#	$worksheet->write($a,11, "",$subt); }
		#else{
		#	$worksheet->write($a,11, ($s1f2_wtd_net_ty)/$s1f2_wtd_target,$subt); }
			
		$worksheet->write($a,7, $s1f2_mtd_net_ty,$border1);
		$worksheet->write($a,8, $s1f2_mtd_net_ly,$border1);
		$worksheet->write($a,10, $s1f2_mtd_target,$border1);
		if ($s1f2_mtd_net_ly <= 0){
			$worksheet->write($a,9, "",$subt); }
		else{
			$worksheet->write($a,9, ($s1f2_mtd_net_ty-$s1f2_mtd_net_ly)/$s1f2_mtd_net_ly,$subt); }
		
		if ($s1f2_mtd_net_ty <= 0 or $s1f2_mtd_target <= 0 ){
			$worksheet->write($a,11, "",$subt); }
		else{
			$worksheet->write($a,11, ($s1f2_mtd_net_ty)/$s1f2_mtd_target,$subt); }
...
if ($mrch1 eq 'DS' and $mrch2 eq 'DS' and $mrch3 eq 'OT' ){
	...
	while(my $s = $sls->fetchrow_hashref()){
		...
		#else{ 		$worksheet->write($a,11, ($s->{wtd_net_ty})/$s->{wtd_target},$subt); 	}
		#
		...
		if ($s->{mtd_net_ly} <= 0){ 		$worksheet->write($a,9, "",$subt); 	}
		else{ 		$worksheet->write($a,9, ($s->{mtd_net_ty}-$s->{mtd_net_ly})/$s->{mtd_net_ly},$subt); 	}
		
		if ($s->{mtd_net_ty} <= 0 or $s->{mtd_target} <= 0){ 		$worksheet->write($a,11, "",$subt); 	}
		else{ 		$worksheet->write($a,11, ($s->{mtd_net_ty})/$s->{mtd_target},$subt); 	}
	...
	while(my $s = $sls->fetchrow_hashref()){
		...
		#else{ 		$worksheet->write($a,16, ($s->{wtd_net_ty})/$s->{wtd_target},$subt); 	}
		...
		if ($s->{mtd_net_ly} <= 0){ 		$worksheet->write($a,14, "",$subt); 	}
		else{ 		$worksheet->write($a,14, ($s->{mtd_net_ty}-$s->{mtd_net_ly})/$s->{mtd_net_ly},$subt); 	}
		
		if ($s->{mtd_net_ty} <= 0 or $s->{mtd_target} <= 0){ 		$worksheet->write($a,16, "",$subt); 	}
		else{ 		$worksheet->write($a,16, ($s->{mtd_net_ty})/$s->{mtd_target},$subt); 	}
	...
	$sls_2 = $dbh_csv->prepare (qq{SELECT merch_group_code_rev, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly
								 FROM $table 
								 WHERE (((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
																		(division = '$division_grp2' and (department_code = '$dept_grp1' or department_code = '$dept_grp2' 
																										or department_code = '$dept_grp3' or department_code = '$dept_grp4' 
...
$worksheet->conditional_formatting( 'H44:W60', { type     => 'cell',  criteria => '=', value    => 0, format   => $blank });	
$worksheet->conditional_formatting( 'F9:Y2000',  { type => 'cell', criteria => '<', value => 0, format => $down } );		

$sls = $dbh_csv->prepare (qq{SELECT store_code, store_description, merch_group_code_rev, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly
								 FROM $table 
								 WHERE (((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
																		(division = '$division_grp2' and (department_code = '$dept_grp1' or department_code = '$dept_grp2' 
																										or department_code = '$dept_grp3' or department_code = '$dept_grp4' 
...
if ($mrch1 eq 'DS' and $mrch2 eq 'DS' and $mrch3 eq 'OT' ){	
	...
	while(my $s = $sls->fetchrow_hashref()){
		...
		if($s1f2_counter eq 2){
			...
			#else{ 				$worksheet->write($a,16, ($s1f2_wtd_net_ty)/$s1f2_wtd_target,$subt); }
			...
			if ($s1f2_mtd_net_ly <= 0){ 				$worksheet->write($a,14, "",$subt); }
			else{ 				$worksheet->write($a,14, ($s1f2_mtd_net_ty-$s1f2_mtd_net_ly)/$s1f2_mtd_net_ly,$subt); }
			
			if ($s1f2_mtd_net_ty <= 0 or $s1f2_mtd_target <= 0 ){ 				$worksheet->write($a,16, "",$subt); }
			else{ 				$worksheet->write($a,16, ($s1f2_mtd_net_ty)/$s1f2_mtd_target,$subt); }
	...
	$sls_2 = $dbh_csv->prepare (qq{SELECT store_code, store_description, merch_group_code_rev, SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly
								 FROM $table 
								 WHERE (((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
																		(division = '$division_grp2' and (department_code = '$dept_grp1' or department_code = '$dept_grp2' 
																										or department_code = '$dept_grp3' or department_code = '$dept_grp4' 
	...
	$worksheet->write($a,6, $s->{store_description},$desc);
		...
		if($s->{merch_group_code_rev} eq 'DS'){
			...
			#else{ 		$worksheet->write($a,9, ($s->{wtd_net_ty}-$s->{wtd_net_ly})/$s->{wtd_net_ly},$subt); 	}
			#
			#if ($s->{net_ty} <= 0 or $s->{wtd_target} <= 0){ 		$worksheet->write($a,11, "",$subt); 	}
			#else{ 		$worksheet->write($a,11, ($s->{wtd_net_ty})/$s->{wtd_target},$subt); 	}
			...
			#else{ 		$worksheet->write($a,14, ($s->{wtd_net_ty}-$s->{wtd_net_ly})/$s->{wtd_net_ly},$subt); 	}
			#
			#if ($s->{net_ty} <= 0 or $s->{wtd_target} <= 0){ 		$worksheet->write($a,16, "",$subt); 	}
			#else{ 		$worksheet->write($a,16, ($s->{wtd_net_ty})/$s->{wtd_target},$subt); 	}
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_event_sales_perf_23.csv" or die "bi_event_sales_perf_23.csv: $!";

$test = qq{ 
SELECT STORE_FORMAT, STORE_FORMAT_DESC, STORE_CODE, STORE, STORE_DESCRIPTION, MERCH_GROUP_CODE_REV, MERCH_GROUP_DESC_REV, MERCH_GROUP_CODE, MERCH_GROUP_DESC, GROUP_CODE, GROUP_DESC, DIVISION, DIVISION_DESC, DEPARTMENT_CODE, DEPARTMENT_DESC, 
case when store_code in ('3010','3009','3012','6004','6009','6012','6013','6011') then 1 else 0 end as NEW_FLG, 
case when store_code in ('3010','3009','3012','6004','6009','6012','6013','6011') then 0 else 1 end as MATURED_FLG, 
TARGET_SALE_VAL, NET_SALE_TY, NET_SALE_LY, MTD_TARGET_SALE_VAL, MTD_NET_SALE_TY, MTD_NET_SALE_LY
FROM (
...
, SUM(NVL(WTD.TARGET_SALE_VAL,0)+NVL(WTD.NET_SALE_TY,0)+NVL(WTD.NET_SALE_LY,0)+NVL(MTD.TARGET_SALE_VAL,0)+NVL(MTD.NET_SALE_TY,0)+NVL(MTD.NET_SALE_LY,0)) SALE_CHECK
FROM
...
0 AS TARGET_SALE_VAL, 0 AS TARGET_SALE_VAL_LY, 0 AS TARGET_SALE_VAT, 0 AS TARGET_SALE_VAT_LY 	FROM
		...
		WHERE DATE_KEY BETWEEN $day_st_date_key AND $day_st_date_key
		...
		FROM AGG_DLY_STR_PROD AGG 
			INNER JOIN DIM_PRODUCT M ON AGG.PRODUCT_KEY = M.PRODUCT_KEY 
			INNER JOIN DIM_SUB_DEPT D ON M.MERCH_GROUP_CODE = D.MERCH_GROUP_CODE AND M.GROUP_CODE = D.GROUP_CODE AND M.GROUP2_CODE = D.GROUP2_CODE AND M.DIVISION = D.DIVISION AND M.DEPARTMENT_CODE = D.DEPARTMENT_CODE AND M.SUB_DEPARTMENT_CODE = D.SUB_DEPARTMENT_CODE
		WHERE DATE_KEY BETWEEN $day_st_date_key_ly AND $day_st_date_key_ly 
	...
	WHERE A.DATE_KEY BETWEEN $day_st_date_key AND $day_st_date_key
...
0 AS TARGET_SALE_VAL, 0 AS TARGET_SALE_VAL_LY, 0 AS TARGET_SALE_VAT, 0 AS TARGET_SALE_VAT_LY 	FROM
		...
		FROM AGG_DLY_STR_PROD AGG 
			INNER JOIN DIM_PRODUCT M ON AGG.PRODUCT_KEY = M.PRODUCT_KEY 
			INNER JOIN DIM_SUB_DEPT D ON M.MERCH_GROUP_CODE = D.MERCH_GROUP_CODE AND M.GROUP_CODE = D.GROUP_CODE AND M.GROUP2_CODE = D.GROUP2_CODE AND M.DIVISION = D.DIVISION AND M.DEPARTMENT_CODE = D.DEPARTMENT_CODE AND M.SUB_DEPARTMENT_CODE = D.SUB_DEPARTMENT_CODE
		WHERE DATE_KEY BETWEEN $event_st_date_key AND $event_en_date_key
		GROUP BY STORE_KEY, DS_KEY, STORE_CODE)TY
		ON TBL.STORE_KEY = TY.STORE_KEY AND TBL.STORE_CODE = TY.STORE_CODE AND TBL.DS_KEY = TY.DS_KEY
		LEFT JOIN
		(SELECT
		...
		FROM AGG_DLY_STR_PROD AGG 
			INNER JOIN DIM_PRODUCT M ON AGG.PRODUCT_KEY = M.PRODUCT_KEY 
			INNER JOIN DIM_SUB_DEPT D ON M.MERCH_GROUP_CODE = D.MERCH_GROUP_CODE AND M.GROUP_CODE = D.GROUP_CODE AND M.GROUP2_CODE = D.GROUP2_CODE AND M.DIVISION = D.DIVISION AND M.DEPARTMENT_CODE = D.DEPARTMENT_CODE AND M.SUB_DEPARTMENT_CODE = D.SUB_DEPARTMENT_CODE
		WHERE DATE_KEY BETWEEN $event_st_date_key_ly AND $event_en_date_key_ly
		GROUP BY STORE_KEY, DS_KEY, STORE_CODE)LY 
		ON TBL.STORE_KEY = LY.STORE_KEY AND TBL.STORE_CODE = LY.STORE_CODE AND TBL.DS_KEY = LY.DS_KEY 
	UNION ALL 
	SELECT STORE_KEY, DS_KEY, CAST(STORE_CODE AS VARCHAR2(20)) AS STORE_CODE, 
		...
		SUM (TARGET_SALE_VAT_LY) AS TARGET_SALE_VAT_LY 
	FROM FCT_TARGET A JOIN DIM_DATE_PRL DP ON A.DATE_KEY = DP.DATE_KEY 
	WHERE A.DATE_KEY BETWEEN $event_st_date_key AND $event_en_date_key
	GROUP BY STORE_KEY, STORE_CODE, DS_KEY 		
		) AGG_MLY_STR_DEPT_TARGET,DIM_STORE,DIM_SUB_DEPT 
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_event_sales_perf_23.csv: $!";
...
$to = 'karan.malani@metroretail.com.ph, lia.chipeco@metroretail.com.ph,fili.mercado@metroretail.com.ph,chit.lazaro@metroretail.com';

$cc = 'edna.prieto@metroretail.com.ph,jayson.angeles@metroretail.com.ph,jennifer.yu@metroretail.com.ph,tessie.baldezamo@metroretail.com.ph,april.agapito@metroretail.com.ph,fe.botero@metroretail.com.ph,jeannie.demecillo@metroretail.com.ph,mariegrace.ong@metroretail.com.ph,tessie.cabanero@metroretail.com.ph,joyce.mirabueno@metroretail.com.ph,zenda.mangabon@metroretail.com.ph,jennifer.nardo@metroretail.com.ph,liberato.rodriguez@metroretail.com.ph,rex.cabanilla@metroretail.com.ph, annalyn.conde@metroretail.com.ph, lea.gonzaga@metroretail.com.ph, cham.burgos@metroretail.com.ph,rashel.legaspi@metroretail.com.ph,lanie.danong@metroretail.com.ph ';

$bcc = 'rex.cabanilla@metroretail.com.ph,roel.gevana@metroretail.com.ph,wendell.manumbaga@metroretail.com.ph,bernadette.rosell@metroretail.com.ph,annalyn.conde@metroretail.com.ph, lea.gonzaga@metroretail.com.ph, eric.molina@metroretail.com.ph,philip.coranado@metroretail.com.ph,dax.granados@metroretail.com.ph';

#$to = 'rex.cabanilla@metroretail.com.ph, annalyn.conde@metroretail.com.ph, lea.gonzaga@metroretail.com.ph, cham.burgos@metroretail.com.ph, kent.mamalias@metroretail.com.ph';
...
$subject = 'Event Sales Performance (SIDEWALK SALE) as of ' . $as_of;

$msgbody_file = 'message_event.txt';

$attachment_file_1 = "Event Sales Performance - Summary (as of $as_of) v2.4.xlsx";
...
#$cc = ' arthur.emmanuel@metroretail.com.ph, frank.gaisano@metroretail.com.ph, lucille.malazarte@metroretail.com.ph, rose.jose@metroretail.com.ph, rex.cabanilla@metroretail.com.ph, margaret.ang@metroretail.com.ph, annalyn.conde@metroretail.com.ph ';

# $bcc = ' kent.mamalias@metroretail.com.ph, lea.gonzaga@metroretail.com.ph, cham.burgos@metroretail.com.ph, roel.gevana@metroretail.com.ph ';
...
# $cc = ' arthur.emmanuel@metroretail.com.ph, frank.gaisano@metroretail.com.ph, gerry.guanlao@metroretail.com.ph, eric.redona@metroretail.com.ph, lucille.malazarte@metroretail.com.ph, rose.jose@metroretail.com.ph, rex.cabanilla@metroretail.com.ph, margaret.ang@metroretail.com.ph, annalyn.conde@metroretail.com.ph ';
...
$subject = 'Event Sales Performance (Appliance Summer Sale 2015) as of ' . $as_of;
...
<html>
Hi All, <br> <br>
Please see attached Event Sales Performance Report. <br> <br>

Please be advised that the report as of $as_of is incomplete for the list of stores below due to delayed sales posting. The IT team is currently reviewing the  process and finding ways to further stabilize the report. An updated report will be sent tomorrow after found complete and accurate. <br> <br>
