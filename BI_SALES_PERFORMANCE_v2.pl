...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v2.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance - Summary (as of } . $as_of . q{) v2.xlsx" pdf});
	$pdf_job_1->run(60);	
...
foreach my $i ( 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2223, 3000, 3007, 3008, 3009, 3010, 3011, 3013, 4003, 4004, 6001, 6002, 6003, 6004, 6005, 6006, 6009, 6010, 6011, 6012, 6013 ){
