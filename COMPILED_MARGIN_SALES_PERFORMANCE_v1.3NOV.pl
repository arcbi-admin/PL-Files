...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("TOTAL MARGIN PERFORMANCE (as of $as_of) v1.3QTD.xlsx");
...
$worksheet->write($a-8, 3, "MTD: 01 Oct 2014 - 31 Dec 2014");
...
$worksheet->write($a-9, 3, "MTD: 01 Oct 2014 - 31 Dec 2014");
...
$worksheet->write($a-9, 3, "Total Margin Performance", $bold1);
$worksheet->write($a-8, 3, "MTD: 01 Nov 2013 - 30 Nov 2013");
$worksheet->write($a-7, 3, "As of $as_of");
...
$table = 'consolidated_margin_nov.csv';
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "consolidated_margin_nov.csv" or die "consolidated_margin_nov.csv: $!";
...
FROM
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) OTR_UNITS, SUM(T.OTR_COST) OTR_COST, SUM(T.OTR_RETAIL) OTR_RETAIL, SUM((NVL(T.OTR_RETAIL,0))-(NVL(T.TOTAL_COST,0))) OTR_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST OTR_COST, TDH.TOTAL_RETAIL OTR_RETAIL, 
			...
			WHERE (TDH.TRAN_DATE BETWEEN \'01-OCT-14\' AND \'31-DEC-14\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 0)T
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) CON_UNITS, SUM(T.CON_COST) CON_COST, SUM(T.CON_RETAIL) CON_RETAIL, SUM((NVL(T.CON_RETAIL,0))-(NVL(T.TOTAL_COST,0))) CON_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST CON_COST, TDH.TOTAL_RETAIL CON_RETAIL, 
			...
			--FROM TRAN_DATA_HISTORY_BUP TDH 
				JOIN DEPS ON TDH.DEPT = DEPS.DEPT
			WHERE (TDH.TRAN_DATE BETWEEN \'01-OCT-14\' AND \'31-DEC-14\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 2)T
	...
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'501000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503200\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503250\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503500\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'506000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\'   --AND MG.RMS_LOC_NO NOT IN (\'80061\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\'  
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'507000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\'   --AND MG.RMS_LOC_NO NOT IN (\'80061\')
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'999998\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'505000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'504000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'432000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'433000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'458490\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'434000\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'458550\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460100\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460200\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460300\') AND CC.SEGMENT1=\'240\' --AND CC.SEGMENT1 IN (\'210\',\'211\',\'220\',\'240\',\'230\',\'250\',\'270\',\'280\',\'300\') 
		AND H.PERIOD_NAME IN (\'OCT-14\',\'NOV-14\', \'DEC-14\') --AND H.PERIOD_NAME = \'DEC-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "consolidated_margin_nov.csv: $!";
...
$subject = '(Q4 2014) Sales and Margin Performance ' . $as_of;
$msgbody_file = 'message_margin.txt';

$attachment_file_1 = "TOTAL MARGIN PERFORMANCE (as of $as_of) v1.3QTD.xlsx";
