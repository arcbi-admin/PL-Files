...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v2.5.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance - Summary (as of } . $as_of . q{) v2.5.xlsx" pdf});
	$pdf_job_1->run(60);	
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_25x.csv" or die "bi_sales_perf_25x.csv: $!";

$test = qq{ 
SELECT STORE_FORMAT, STORE_FORMAT_DESC, STORE_CODE, STORE, STORE_DESCRIPTION, MERCH_GROUP_CODE_REV, MERCH_GROUP_CODE, MERCH_GROUP_DESC, GROUP_CODE, GROUP_DESC,
DIVISION, DIVISION_DESC, DEPARTMENT_CODE, DEPARTMENT_DESC, 
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_25x.csv: $!";
...
$bcc = ' rex.cabanilla@metrogaisano.com, kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, fnaquines@metro.com.ph, cham.burgos@metrogaisano.com, roel.gevana@metrogaisano.com, rlegaspi@metro.com.ph ';
...
$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v2.5.xlsx";
$attachment_file_2 = "Daily Sales Performance - Summary (as of $as_of) v2.5.pdf";
