...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Outright (as of $as_of) v1.1.xlsx");
...
$table = 'bi_sales_perf_otr_11.csv';
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_otr_11.csv" or die "bi_sales_perf_otr_11.csv: $!";
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_otr_11.csv: $!";
...
$attachment_file_1 = "Daily Sales Performance - Outright (as of $as_of) v1.1.xlsx";
