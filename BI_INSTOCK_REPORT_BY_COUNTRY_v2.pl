...
$test = qq{ 
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011',) THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'China_HK_Taiwan' AS COUNTRY FROM
...
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'India' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO		
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Indonesia' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Japan' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Korea' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Malaysia' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Singapore' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Thailand' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO		
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Vietnam' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
