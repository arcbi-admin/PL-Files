...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v1.6.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance - Summary (as of } . $as_of . q{) v1.6.xlsx" pdf});
	$pdf_job_1->run(60);	
...
#foreach my $i ( '2001', '2001W' ){ 
	...
	# &heading_2;
	# &heading;
	# &query_dept_store($store = $i, $wtd_net_ly = 0, $mtd_net_ly = 0, $qtd_net_ly = 0);
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_16.csv" or die "bi_sales_perf_16.csv: $!";
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_16.csv: $!";
...
$to = ' arthur.emmanuel@metrogaisano.com, frank.gaisano@metrogaisano.com, eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, jj.moreno@metrogaisano.com, rose.jose@metrogaisano.com, rex.cabanilla@metrogaisano.com, margaret.ang@metrogaisano.com  ';

$bcc = ' kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, frank.naquines@metrogaisano.com, cham.burgos@metrogaisano.com, arlene.valdez@metrogaisano.com ';
...
$to = ' arthur.emmanuel@metrogaisano.com, frank.gaisano@metrogaisano.com, gerry.guanlao@metrogaisano.com, eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, jj.moreno@metrogaisano.com, rose.jose@metrogaisano.com, rex.cabanilla@metrogaisano.com, margaret.ang@metrogaisano.com, aljim.jamandre@metrogaisano.com';
