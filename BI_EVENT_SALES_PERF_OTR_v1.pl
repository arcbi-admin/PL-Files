...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("(Outright)Event Sales Performance - Summary (as of $as_of) v1.xlsx");
...
$worksheet->write($a-9, 2, "(Outright)Event Sales Performance (Sidewalk Sales 2015)", $bold1);
...
$worksheet->write($a-9, 3, "(Outright)Event Sales Performance (Sidewalk Sales 2015)", $bold1);
