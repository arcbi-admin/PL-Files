...
printf "BY COUNTRY IN STOCK REPORT \n";
...
$test = qq{ 
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'China_HK_Taiwan' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			...
			WHERE S.STORE IN ('2001','2002','2003','2008','2010','2011','4002','4003','3009','6001','6003','6005','6010','3001','3002','3003','3004','3005','3006','6004','6009','2004','2005','2006','2007','2009','2012','2013','2223','3007 ','3012','4004','6002','6012','2101','2102','80001','80011','80031','80041','80051','80061')
...
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'India' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO		
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Indonesia' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Japan' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Korea' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Malaysia' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Singapore' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO	
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Thailand' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
	...
	(SELECT GROUP_NO, LOCATION, LOC_NAME, COUNT(REPL_TAG) TOT_REPL_ITEMS, COUNT(STOCK_TAG) REPL_WITH_SOH
		...
		GROUP BY GROUP_NO, LOCATION, LOC_NAME)STK ON SGD.STORE = STK.LOCATION AND SGD.GROUP_NO = STK.GROUP_NO		
UNION ALL
SELECT SGD.GROUP_NO, SGD.STORE, SGD.STORE_NAME, CASE WHEN SGD.STORE IN ('2004','2005','2006','2007','2009','2012','2013','2223','3007','3012','4004','6002','6012','6013','6011','2101','2102') THEN '2'     WHEN SGD.STORE IN ('80001','80011','80031','80041','80051','80061') THEN '3' ELSE '1' END AS AREA, STK.TOT_REPL_ITEMS, STK.REPL_WITH_SOH, 'Vietnam' AS COUNTRY FROM
	(SELECT S.STORE, S.STORE_NAME, M.MERCH_GROUP_CODE, M.MERCH_GROUP_DESC, M.ATTRIB1, M.ATTRIB2, M.DIVISION, M.DIV_NAME, M.GROUP_NO, M.GROUP_NAME 
			FROM
				(SELECT DISTINCT STORE, STORE_NAME FROM STORE WHERE STORE NOT IN (6008) UNION ALL SELECT DISTINCT WH AS STORE, WH_NAME STORE_NAME FROM WH)S,   
				(SELECT B.MERCH_GROUP_CODE, B.MERCH_GROUP_DESC, B.ATTRIB1 ATTRIB1, B.ATTRIB2, G.DIVISION, I.DIV_NAME, D.GROUP_NO, G.GROUP_NAME, D.PURCHASE_TYPE, D.DEPT, D.DEPT_NAME 
...
$to = 'cherry.gulloy@metrogaisano.com, janice.bedrijo@metrogaisano.com, jerson.roma@metrogaisano.com, bermon.alcantara@metrogaisano.com, eljie.laquinon@metrogaisano.com, nilynn.yosores@metrogaisano.com, analiza.dano@metrogaisano.com, anafatima.mancho@metrogaisano.com, emily.silverio@metrogaisano.com, luz.bitang@metrogaisano.com';
#$to = 'lloydpatrick.flores@metroretail.com.ph';
$bcc = 'lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, rex.cabanilla@metrogaisano.com';
...
$to = 'manuel.degamo@metrogaisano.com, ace.olalia@metrogaisano.com, alma.espino@metrogaisano.com, angeli_christi.ladot@metrogaisano.com, angelito.dublin@metrogaisano.com, arlene.yanson@metrogaisano.com, augosto.daria@metrogaisano.com,  flor.bolante@metrogaisano.com, teena.velasco@metrogaisano.com, cristy.sy@metrogaisano.com, diana.almagro@metrogaisano.com, edgardo.lim@metrogaisano.com, edris.tarrobal@metrogaisano.com, fidela.villamor@metrogaisano.com, genaro.felisilda@metrogaisano.com, genevive.quinones@metrogaisano.com, glenda.navares@metrogaisano.com, jonalyn.diaz@metrogaisano.com,
cherry.gulloy@metroretail.com.ph,nilynn.yosores@metroretail.com.ph,lorna.montejo@metroretail.com.ph,gea.badiang@metroretail.com.ph';
#$to = 'lloydpatrick.flores@metroretail.com.ph';
#$bcc = 'lea.gonzaga@metrogaisano.com';
