...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Outright (as of $as_of) V1.4.xlsx");
...
$worksheet->write($a-11, 2, "Daily Sales Performance - Outright", $bold1);
...
$a=11, $counter=0, $comp_su = 0, $new_su = 0, $comp_nb = 0, $comp_hy = 0, $new_hy = 0, $comp_ds = 0, $new_ds = 0, $type_test = 1;

$worksheet->write($a-11, 3, "Daily Sales Performance - Outright", $bold1);
...
$a=11, $d=0, $e=10, $counter=0, $comp_su = 0, $new_su = 0, $comp_nb = 0, $comp_hy = 0, $new_hy = 0, $comp_ds = 0, $new_ds = 0, $type_test = 3;
...
$sls = $dbh->prepare (qq{
	...
	FROM
		...
		(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT, 
						SUM(TARGET_SALE_VAL) AS WTD_TARGET, SUM(NET_SALE_OTR_TY) AS WTD_NET_TY, SUM(NET_SALE_OTR_LY) AS WTD_NET_LY, 
		...
		SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT, 
						...
						SUM(TARGET_SALE_VAL) AS MTD_TARGET, SUM(NET_SALE_OTR_TY) AS MTD_NET_TY, SUM(NET_SALE_OTR_LY) AS MTD_NET_LY, 
						0 AS QTD_TARGET, 0 AS QTD_NET_TY, 0 AS QTD_NET_LY, 
						0 AS YTD_TARGET, 0 AS YTD_NET_TY, 0 AS YTD_NET_LY 
		...
		SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT, 
						0 AS WTD_TARGET, 0 AS WTD_NET_TY, 0 AS WTD_NET_LY, 
						0 AS MTD_TARGET, 0 AS MTD_NET_TY, 0 AS MTD_NET_LY, 
						SUM(TARGET_SALE_VAL) AS QTD_TARGET, SUM(NET_SALE_OTR_TY) AS QTD_NET_TY, SUM(NET_SALE_OTR_LY) AS QTD_NET_LY, 
						0 AS YTD_TARGET, 0 AS YTD_NET_TY, 0 AS YTD_NET_LY 
						FROM METRO_IT_SALES_DEPT 
		WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
		...
		SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT, 
						...
						0 AS MTD_TARGET, 0 AS MTD_NET_TY, 0 AS MTD_NET_LY, 
						0 AS QTD_TARGET, 0 AS QTD_NET_TY, 0 AS QTD_NET_LY, 
						SUM(TARGET_SALE_VAL) YTD_TARGET, SUM(NET_SALE_OTR_TY) YTD_NET_TY, SUM(NET_SALE_OTR_LY) YTD_NET_LY 
						FROM METRO_IT_SALES_DEPT 
		WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
			AND YEAR = (SELECT TO_CHAR(SYSDATE, 'YYYY') FROM DUAL) AND MERCH_GROUP_CODE <> 'Z_OT' 
...
(SELECT A.FORMAT, WTD_TARGET_DS, WTD_NET_TY_DS, WTD_NET_LY_DS, MTD_TARGET_DS, MTD_NET_TY_DS, MTD_NET_LY_DS, QTD_TARGET_DS, QTD_NET_TY_DS, QTD_NET_LY_DS, YTD_TARGET_DS, YTD_NET_TY_DS, YTD_NET_LY_DS, WTD_TARGET_SU, WTD_NET_TY_SU, WTD_NET_LY_SU, MTD_TARGET_SU, MTD_NET_TY_SU, MTD_NET_LY_SU, QTD_TARGET_SU, QTD_NET_TY_SU, QTD_NET_LY_SU, YTD_TARGET_SU, YTD_NET_TY_SU, YTD_NET_LY_SU FROM
	...
	SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_DS, 
							SUM(TARGET_SALE_VAL) AS WTD_TARGET_DS, SUM(NET_SALE_OTR_TY) AS WTD_NET_TY_DS, SUM(NET_SALE_OTR_LY) AS WTD_NET_LY_DS, 
	...
	(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_SU, 
							SUM(TARGET_SALE_VAL) AS WTD_TARGET_SU, SUM(NET_SALE_OTR_TY) AS WTD_NET_TY_SU, SUM(NET_SALE_OTR_LY) AS WTD_NET_LY_SU, 
...
SELECT A.FORMAT, WTD_TARGET_DS, WTD_NET_TY_DS, WTD_NET_LY_DS, MTD_TARGET_DS, MTD_NET_TY_DS, MTD_NET_LY_DS, QTD_TARGET_DS, QTD_NET_TY_DS, QTD_NET_LY_DS, YTD_TARGET_DS, YTD_NET_TY_DS, YTD_NET_LY_DS, WTD_TARGET_SU, WTD_NET_TY_SU, WTD_NET_LY_SU, MTD_TARGET_SU, MTD_NET_TY_SU, MTD_NET_LY_SU, QTD_TARGET_SU, QTD_NET_TY_SU, QTD_NET_LY_SU, YTD_TARGET_SU, YTD_NET_TY_SU, YTD_NET_LY_SU FROM	
	...
	(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_DS, 
						...
						SUM(TARGET_SALE_VAL) AS MTD_TARGET_DS, SUM(NET_SALE_OTR_TY) AS MTD_NET_TY_DS, SUM(NET_SALE_OTR_LY) AS MTD_NET_LY_DS,
						0 AS QTD_TARGET_DS, 0 AS QTD_NET_TY_DS, 0 AS QTD_NET_LY_DS, 
						0 AS YTD_TARGET_DS, 0 AS YTD_NET_TY_DS, 0 AS YTD_NET_LY_DS
	FROM METRO_IT_SALES_DEPT 
	WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
	...
	(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_SU, 
						...
						SUM(TARGET_SALE_VAL) AS MTD_TARGET_SU, SUM(NET_SALE_OTR_TY) AS MTD_NET_TY_SU, SUM(NET_SALE_OTR_LY) AS MTD_NET_LY_SU,
						0 AS QTD_TARGET_SU, 0 AS QTD_NET_TY_SU, 0 AS QTD_NET_LY_SU, 
						0 AS YTD_TARGET_SU, 0 AS YTD_NET_TY_SU, 0 AS YTD_NET_LY_SU
	FROM METRO_IT_SALES_DEPT 
	WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
...
SELECT A.FORMAT, WTD_TARGET_DS, WTD_NET_TY_DS, WTD_NET_LY_DS, MTD_TARGET_DS, MTD_NET_TY_DS, MTD_NET_LY_DS, QTD_TARGET_DS, QTD_NET_TY_DS, QTD_NET_LY_DS, YTD_TARGET_DS, YTD_NET_TY_DS, YTD_NET_LY_DS, WTD_TARGET_SU, WTD_NET_TY_SU, WTD_NET_LY_SU, MTD_TARGET_SU, MTD_NET_TY_SU, MTD_NET_LY_SU, QTD_TARGET_SU, QTD_NET_TY_SU, QTD_NET_LY_SU, YTD_TARGET_SU, YTD_NET_TY_SU, YTD_NET_LY_SU FROM	
	...
	(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_DS, 
						0 AS WTD_TARGET_DS, 0 AS WTD_NET_TY_DS, 0 AS WTD_NET_LY_DS, 
						0 AS MTD_TARGET_DS, 0 AS MTD_NET_TY_DS, 0 AS MTD_NET_LY_DS,
						SUM(TARGET_SALE_VAL) AS QTD_TARGET_DS, SUM(NET_SALE_OTR_TY) AS QTD_NET_TY_DS, SUM(NET_SALE_OTR_LY) AS QTD_NET_LY_DS,
						0 AS YTD_TARGET_DS, 0 AS YTD_NET_TY_DS, 0 AS YTD_NET_LY_DS
	FROM METRO_IT_SALES_DEPT 
	WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
		AND YEAR = (SELECT TO_CHAR(SYSDATE, 'YYYY') FROM DUAL) AND MERCH_GROUP_CODE = 'DS' AND MERCH_GROUP_CODE <> 'Z_OT' 
	...
	(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_SU, 
						0 AS WTD_TARGET_SU, 0 AS WTD_NET_TY_SU, 0 AS WTD_NET_LY_SU, 
						0 AS MTD_TARGET_SU, 0 AS MTD_NET_TY_SU, 0 AS MTD_NET_LY_SU,
						SUM(TARGET_SALE_VAL) AS QTD_TARGET_SU, SUM(NET_SALE_OTR_TY) AS QTD_NET_TY_SU, SUM(NET_SALE_OTR_LY) AS QTD_NET_LY_SU,
						0 AS YTD_TARGET_SU, 0 AS YTD_NET_TY_SU, 0 AS YTD_NET_LY_SU
	FROM METRO_IT_SALES_DEPT 
	WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
		AND YEAR = (SELECT TO_CHAR(SYSDATE, 'YYYY') FROM DUAL) AND MERCH_GROUP_CODE = 'SU' AND MERCH_GROUP_CODE <> 'Z_OT'
...
SELECT A.FORMAT, WTD_TARGET_DS, WTD_NET_TY_DS, WTD_NET_LY_DS, MTD_TARGET_DS, MTD_NET_TY_DS, MTD_NET_LY_DS, QTD_TARGET_DS, QTD_NET_TY_DS, QTD_NET_LY_DS, YTD_TARGET_DS, YTD_NET_TY_DS, YTD_NET_LY_DS, WTD_TARGET_SU, WTD_NET_TY_SU, WTD_NET_LY_SU, MTD_TARGET_SU, MTD_NET_TY_SU, MTD_NET_LY_SU, QTD_TARGET_SU, QTD_NET_TY_SU, QTD_NET_LY_SU, YTD_TARGET_SU, YTD_NET_TY_SU, YTD_NET_LY_SU FROM	
	...
	(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_DS, 
						...
						0 AS MTD_TARGET_DS, 0 AS MTD_NET_TY_DS, 0 AS MTD_NET_LY_DS, 
						0 AS QTD_TARGET_DS, 0 AS QTD_NET_TY_DS, 0 AS QTD_NET_LY_DS, 
						SUM(TARGET_SALE_VAL) AS YTD_TARGET_DS, SUM(NET_SALE_OTR_TY) AS YTD_NET_TY_DS, SUM(NET_SALE_OTR_LY) AS YTD_NET_LY_DS
	FROM METRO_IT_SALES_DEPT 
	WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
		AND YEAR = (SELECT TO_CHAR(SYSDATE, 'YYYY') FROM DUAL) AND MERCH_GROUP_CODE = 'DS' AND MERCH_GROUP_CODE <> 'Z_OT' 
	GROUP BY CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END)DS
	...
	(SELECT CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END AS FORMAT_SU, 
						...
						0 AS MTD_TARGET_SU, 0 AS MTD_NET_TY_SU, 0 AS MTD_NET_LY_SU, 
						0 AS QTD_TARGET_SU, 0 AS QTD_NET_TY_SU, 0 AS QTD_NET_LY_SU, 
						SUM(TARGET_SALE_VAL) AS YTD_TARGET_SU, SUM(NET_SALE_OTR_TY) AS YTD_NET_TY_SU, SUM(NET_SALE_OTR_LY) AS YTD_NET_LY_SU
	FROM METRO_IT_SALES_DEPT 
	WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
		AND YEAR = (SELECT TO_CHAR(SYSDATE, 'YYYY') FROM DUAL) AND MERCH_GROUP_CODE = 'SU' AND MERCH_GROUP_CODE <> 'Z_OT' 
	GROUP BY CASE WHEN STORE_FORMAT = '3' THEN MERCH_GROUP_DESC ELSE UPPER(STORE_FORMAT_DESC) END)SU
...
$sls = $dbh->prepare (qq{
			...
			FROM
				...
				SELECT 
					...
					0 AS MTD_TARGET, 0 AS MTD_NET_TY, 0 AS MTD_NET_LY, 
					0 AS QTD_TARGET, 0 AS QTD_NET_TY, 0 AS QTD_NET_LY,  
					SUM(TARGET_SALE_VAL) AS YTD_TARGET, SUM(NET_SALE_OTR_TY) AS YTD_NET_TY, SUM(NET_SALE_OTR_LY) AS YTD_NET_LY
				FROM METRO_IT_SALES_DEPT 
				WHERE ((NEW_FLG = '$new_flg1' OR NEW_FLG = '$new_flg2') AND (MATURED_FLG = '$matured_flg1' OR MATURED_FLG = '$matured_flg2')) 
					AND YEAR = (SELECT TO_CHAR(SYSDATE, 'YYYY') FROM DUAL))
			});								 
...
$attachment_file_1 = "Daily Sales Performance - Outright (as of $as_of) V1.4.xlsx";
