...
$stor1 = '30001'; $stor2 = '3007'; $stor3 = '4003'; $stor4 = '3002'; $stor5 = '3003'; $stor6 = '3004'; $stor7 = '3005'; $stor8 = '3006'; $stor9 = '3012'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';    $stor14 = '0000';     $stor15 = '0000';  
...
$table = 'bi_sales_perf_con_11.csv';
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_con_11.csv" or die "bi_sales_perf_con_11.csv: $!";
...
DIVISION, DIVISION_DESC, DEPARTMENT_CODE, DEPARTMENT_DESC, NEW_FLG, MATURED_FLG, TARGET_SALE_VAL, NET_SALE_TY, NET_SALE_LY, MTD_TARGET_SALE_VAL, MTD_NET_SALE_TY, MTD_NET_SALE_LY, QTD_TARGET_SALE_VAL, QTD_NET_SALE_TY, QTD_NET_SALE_LY 
FROM (
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_con_11.csv: $!";
...
# $to = ' rex.cabanilla@metrogaisano.com, kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, christopher.calalang@metrogaisano.com, annalyn.conde@metrogaisano.com, fnaquines@metro.com.ph, cham.burgos@metrogaisano.com ';
		
$subject = 'Daily Sales Performance - Concession as of ' . $as_of;
$msgbody_file = 'message_BI.txt';

$attachment_file_1 = "Daily Sales Performance - Concession (as of $as_of) v1.1.xlsx";
