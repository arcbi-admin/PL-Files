...
FROM
	...
	AND TO_NUMBER(H.ID_STR_RT) = '2001'	
...
$subject = 'S1:Hourly Sales Performance as of ' . $update_time;
...
<html>
<b><font size="4">Metro Colon: END OF SUMMER SALE</font></b>
<br>
