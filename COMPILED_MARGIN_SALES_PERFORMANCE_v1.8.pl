...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("TOTAL MARGIN PERFORMANCE (as of $as_of) v1.7.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "TOTAL MARGIN PERFORMANCE (as of } . $as_of . q{) v1.7.xlsx" pdf});
	$pdf_job_1->run(1500);	
...
foreach my $i ( '2001', '2001W', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2223', '3001', '3002', '3003', '3004', '3005', '3006', '3007', '3009', '3010', '3012', '4003', '4004', '6001', '6002', '6003', '6004', '6005', '6009', '6010', '6012', '6006','6011','6013','80081','80041','80071','80091','80094','80111','80121','80095','80051','80061','80021','80099','80131','80151','80141','80142','80001','80031','80011','80098','80097','80096','80101'){ 
...
#$to = ' frank.gaisano@metroretail.com.ph, arthur.emmanuel@metroretail.com.ph, lucille.malazarte@metroretail.com.ph, melissa.catan@metroretail.com.ph, rex.cabanilla@metroretail.com.ph, karan.malani@metroretail.com.ph, lia.chipeco@metroretail.com.ph, chit.lazaro@metroretail.com.ph, fili.mercado@metroretail.com.ph,luz.bitang@metroretail.com.ph, emily.silverio@metroretail.com.ph,joel.orense@metroretail.com.ph,dione.kocencio@metroretail.com.ph';

#$bcc = 'lea.gonzaga@metroretail.com.ph, annalyn.conde@metroretail.com.ph,eric.molina@metroretail.com.ph,roel.gevana@metroretail.com.ph, rlegaspi@metro.com.ph, bernadette.rosell@metroretail.com.ph,rashel.legaspi@metroretail.com.ph';
		
$to = ' lea.gonzaga@metroretail.com.ph,lloydpatrick.flores@metroretail.com.ph';
...
$attachment_file_1 = "TOTAL MARGIN PERFORMANCE (as of $as_of) v1.7.xlsx";
$attachment_file_2 = "TOTAL MARGIN PERFORMANCE (as of $as_of) v1.7.pdf";
