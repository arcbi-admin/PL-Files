...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("test CONSOLIDATED MARGIN - Summary (as of $as_of) v1.3.xlsx");
...
$grp_o_retail = 0, $grp_o_margin = 0, $grp_c_retail = 0, $grp_c_margin = 0, $grp_deb_amt432000  = 0, $grp_cre_amt432000  = 0, $grp_amt432000  = 0, $grp_deb_amt433000  = 0, $grp_cre_amt433000  = 0, $grp_amt433000  = 0, $grp_deb_amt458490  = 0, $grp_cre_amt458490  = 0, $grp_amt458490  = 0, $grp_deb_amt434000  = 0, $grp_cre_amt434000  = 0, $grp_amt434000  = 0, $grp_deb_amt458550  = 0, $grp_cre_amt458550  = 0, $grp_amt458550  = 0, $grp_deb_amt460100  = 0, $grp_cre_amt460100  = 0, $grp_amt460100  = 0, $grp_deb_amt460200  = 0, $grp_cre_amt460200  = 0, $grp_amt460200  = 0, $grp_deb_amt460300  = 0, $grp_cre_amt460300  = 0, $grp_amt460300  = 0, $grp_amt_shrnk  = 0, $grp_amt_frt  = 0, $grp_amt_addl_cost  = 0;

$total_o_retail = 0, $total_o_margin = 0, $total_c_retail = 0, $total_c_margin = 0, $total_deb_amt432000  = 0, $total_cre_amt432000  = 0, $total_amt432000  = 0, $total_deb_amt433000  = 0, $total_cre_amt433000  = 0, $total_amt433000  = 0, $total_deb_amt458490  = 0, $total_cre_amt458490  = 0, $total_amt458490  = 0, $total_deb_amt434000  = 0, $total_cre_amt434000  = 0, $total_amt434000  = 0, $total_deb_amt458550  = 0, $total_cre_amt458550  = 0, $total_amt458550  = 0, $total_deb_amt460100  = 0, $total_cre_amt460100  = 0, $total_amt460100  = 0, $total_deb_amt460200  = 0, $total_cre_amt460200  = 0, $total_amt460200  = 0, $total_deb_amt460300  = 0, $total_cre_amt460300  = 0, $total_amt460300  = 0, $total_amt_shrnk  = 0, $total_amt_frt  = 0, $total_amt_addl_cost  = 0;
...
foreach my $i ( '2001', '2001W', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2223', '3001', '3002', '3003', '3004', '3005', '3006', '3007', '3008', '3009', '3010', '3011', '3013', '4003', '4004', '6001', '6002', '6003', '6004', '6005', '6006', '6009', '6010', '6011', '6012', '6013' ){ 
...
$worksheet->write($a-9, 3, "MTD: 01 Oct 2014 - 31 Oct 2014");
...
$s1f2_deb_amt432000 = 0, $s1f2_cre_amt432000 = 0, $s1f2_amt432000 = 0, $s1f2_deb_amt433000 = 0, $s1f2_cre_amt433000 = 0, $s1f2_amt433000 = 0, $s1f2_deb_amt458490 = 0, $s1f2_cre_amt458490 = 0, $s1f2_amt458490 = 0, $s1f2_deb_amt434000 = 0, $s1f2_cre_amt434000 = 0, $s1f2_amt434000 = 0, $s1f2_deb_amt458550 = 0, $s1f2_cre_amt458550 = 0, $s1f2_amt458550 = 0, $s1f2_deb_amt460100 = 0, $s1f2_cre_amt460100 = 0, $s1f2_amt460100 = 0, $s1f2_deb_amt460200 = 0, $s1f2_cre_amt460200 = 0, $s1f2_amt460200 = 0, $s1f2_deb_amt460300 = 0, $s1f2_cre_amt460300 = 0, $s1f2_amt460300 = 0, $s1f2_amt_shrnk = 0, $s1f2_amt_frt = 0, $s1f2_amt_addl_cost = 0;
...
$stor1 = '2013'; $stor2 = '4004'; $stor3 = '3009'; $stor4 = '3010'; $stor5 = '3011'; $stor6 = '0000'; $stor7 = '0000'; $stor8 = '0000'; $stor9 = '0000'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';   $stor14 = '0000'; 
	...
	if($type_test eq 1){	&query_summary;	} 
		...
		$new_su=$a; $a+=1; $b+=1; $d=$a; $counter = 0; #ADD 1 TO VARIABLES A RESET COUNTER
			...
			foreach my $col( 7, 8, 10, 12, 14, 15, 17, 19, 21, 22, 24, 26, 28, 29, 31, 32, 34, 35, 37, 38, 40, 41, 43, 44, 46, 47, 49, 51, 53, 54, 56, 58, 60, 61, 63, 64, 66, 67, 69, 70, 72, 73 ){
				my $sumTY = '=SUM('.xl_rowcol_to_cell($comp_su,$col).','.xl_rowcol_to_cell($new_su,$col).')';
					$worksheet->write( $a, $col, $sumTY, $bodyNum );
					
					if ($col eq 8 or $col eq 15 or $col eq 22 or $col eq 47 or $col eq 54){
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col ). '/' . xl_rowcol_to_cell( $a, $col-1 ) . ')';
							$worksheet->write( $a, $col+1, $pct2sls, $bodyPct );} 
					elsif ($col eq 10 or $col eq 17 or $col eq 24 or $col eq 49 or $col eq 57){
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col ). '/' . xl_rowcol_to_cell( $a, $col-3 ) . ')';
							$worksheet->write( $a, $col+1, $pct2sls, $bodyPct );} 
					elsif ($col eq 12 or $col eq 19 or $col eq 26 or $col eq 51 or $col eq 59){
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col ). '/' . xl_rowcol_to_cell( $a, $col-5 ) . ')';
							$worksheet->write( $a, $col+1, $pct2sls, $bodyPct );} 
					elsif ($col eq 29 or $col eq 32 or $col eq 35 or $col eq 38 or $col eq 41 or $col eq 44 or $col eq 61 or $col eq 64 or $col eq 67 or $col eq 70 or $col eq 73){
			...
			foreach my $col( 7, 8, 10, 12, 14, 15, 17, 19, 21, 22, 24, 26, 28, 29, 31, 32, 34, 35, 37, 38, 40, 41, 43, 44, 46, 47, 49, 51, 53, 54, 56, 58, 60, 61, 63, 64, 66, 67, 69, 70, 72, 73 ){
				my $sumTY = '=SUM('.xl_rowcol_to_cell($comp_nb,$col).')';
					...
					if ($col eq 8 or $col eq 15 or $col eq 22 or $col eq 47 or $col eq 54){
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col ). '/' . xl_rowcol_to_cell( $a, $col-1 ) . ')';
							$worksheet->write( $a, $col+1, $pct2sls, $bodyPct );} 
					elsif ($col eq 10 or $col eq 17 or $col eq 24 or $col eq 49 or $col eq 54){
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col ). '/' . xl_rowcol_to_cell( $a, $col-3 ) . ')';
							$worksheet->write( $a, $col+1, $pct2sls, $bodyPct );} 
					elsif ($col eq 12 or $col eq 19 or $col eq 26 or $col eq 51 or $col eq 59){
							my $pct2sls = '=('. xl_rowcol_to_cell( $a, $col ). '/' . xl_rowcol_to_cell( $a, $col-5 ) . ')';
...
$worksheet->merge_range( $a-4, 14, $a-4, 45, 'OUTRIGHT', $subhead );
$worksheet->merge_range( $a-4, 46, $a-4, 74, 'CONCESSION', $subhead );

$worksheet->merge_range( $a-3, 14, $a-3, 20, 'TOTAL - OUTRIGHT', $subhead );
$worksheet->merge_range( $a-3, 21, $a-3, 27, 'FRONT', $subhead );
$worksheet->merge_range( $a-3, 28, $a-3, 36, 'BACK', $subhead );
$worksheet->merge_range( $a-3, 37, $a-2, 39, 'SHRINKAGE', $subhead );
$worksheet->merge_range( $a-3, 40, $a-2, 42, 'FREIGHT', $subhead );
$worksheet->merge_range( $a-3, 43, $a-2, 45, 'OTHER COST', $subhead );
$worksheet->merge_range( $a-3, 46, $a-3, 52, 'TOTAL - CONCESSION', $subhead );
$worksheet->merge_range( $a-3, 53, $a-3, 59, 'FRONT', $subhead );
$worksheet->merge_range( $a-3, 60, $a-3, 74, 'BACK', $subhead );

foreach my $i ( 7, 14, 21, 46, 53 ) {
...
foreach my $i ( 28, 31, 34, 37, 40, 43, 60, 63, 66, 69, 72 ) {
	$worksheet->write($a-1, $i, 'Actual', $subhead);
	$worksheet->write($a-1, $i+1, 'Budget', $subhead);
	$worksheet->write($a-1, $i+2, 'Var', $subhead);
}

$worksheet->merge_range( $a-2, 28, $a-2, 30, 'Purchase Allowance', $subhead );
$worksheet->merge_range( $a-2, 31, $a-2, 33, 'Purchase Discouns-Special', $subhead );
$worksheet->merge_range( $a-2, 34, $a-2, 36, 'Other Income-Metro Vendor Portal', $subhead );
$worksheet->merge_range( $a-2, 60, $a-2, 62, 'Ad Support', $subhead );
$worksheet->merge_range( $a-2, 63, $a-2, 65, 'Other Income-Storage/Concession', $subhead );
$worksheet->merge_range( $a-2, 66, $a-2, 68, 'Light Recovery', $subhead );
$worksheet->merge_range( $a-2, 69, $a-2, 71, 'Water Recovery', $subhead );
$worksheet->merge_range( $a-2, 72, $a-2, 74, 'Supplies Recovery', $subhead );
...
$worksheet->set_column( 28, 28, 8 );
$worksheet->set_column( 29, 30, undef, undef, 1 );

$worksheet->set_column( 31, 31, 8 );
$worksheet->set_column( 32, 33, undef, undef, 1 );

$worksheet->set_column( 34, 34, 8 );
$worksheet->set_column( 35, 36, undef, undef, 1 );

$worksheet->set_column( 37, 37, 9 );
$worksheet->set_column( 38, 39, undef, undef, 1 );

$worksheet->set_column( 40, 40, 9 );
$worksheet->set_column( 41, 42, undef, undef, 1 );

$worksheet->set_column( 43, 43, 9 );
$worksheet->set_column( 44, 45, undef, undef, 1 );

$worksheet->set_column( 47, 48, 8 );
$worksheet->set_column( 49, 49, 7 );
$worksheet->set_column( 49, 52, undef, undef, 1 );

$worksheet->set_column( 53, 54, 8 );
$worksheet->set_column( 55, 55, 7 );
$worksheet->set_column( 56, 59, undef, undef, 1 );

$worksheet->set_column( 60, 60, 8 );
$worksheet->set_column( 61, 62, undef, undef, 1 );

$worksheet->set_column( 63, 63, 8 );
$worksheet->set_column( 64, 65, undef, undef, 1 );

$worksheet->set_column( 66, 66, 8 );
$worksheet->set_column( 67, 68, undef, undef, 1 );

$worksheet->set_column( 69, 69, 8 );
$worksheet->set_column( 70, 71, undef, undef, 1 );

$worksheet->set_column( 72, 72, 8 );
$worksheet->set_column( 73, 74, undef, undef, 1 );
}
...
while(my $s = $sls1->fetchrow_hashref()){
	...
	while(my $s = $sls2->fetchrow_hashref()){
		...
		while(my $s = $sls3->fetchrow_hashref()){
			...
			while(my $s = $sls4->fetchrow_hashref()){
				...
				$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$border1);
					if (($s->{o_retail}+$s->{c_retail}) le 0){
						$worksheet->write($a,9, "",$subt); }
					else{
						$worksheet->write($a,9, ($s->{o_margin}+$s->{c_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/($s->{o_retail}+$s->{c_retail}),$subt); }
				...
				$worksheet->write($a,15, $s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490},$border1);
					if ($s->{o_retail} le 0){
						$worksheet->write($a,16, "",$subt); }
					else{
						$worksheet->write($a,16, ($s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490})/$s->{o_retail},$subt); }
				...
				$worksheet->write($a,28, $s->{amt432000},$border1);
				$worksheet->write($a,29, "",$border1);
				$worksheet->write($a,30, "",$border1);
				
				$worksheet->write($a,31, $s->{amt433000},$border1);
				$worksheet->write($a,32, "",$border1);
				$worksheet->write($a,33, "",$border1);
				
				$worksheet->write($a,34, $s->{amt458490},$border1);
				$worksheet->write($a,35, "",$border1);
				$worksheet->write($a,36, "",$border1);
				
				$worksheet->write($a,37, $s->{amt_shrnk},$border1);
				$worksheet->write($a,38, "",$border1);
				$worksheet->write($a,39, "",$border1);
			
				$worksheet->write($a,40, $s->{amt_frt},$border1);
				$worksheet->write($a,41, "",$border1);
				$worksheet->write($a,42, "",$border1);
				
				$worksheet->write($a,43, $s->{amt_addl_cost},$border1);
				$worksheet->write($a,44, "",$border1);
				$worksheet->write($a,45, "",$border1);
				
				$worksheet->write($a,46, $s->{c_retail},$border1);
				$worksheet->write($a,47, $s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$border1);
					if ($s->{c_retail} le 0){
						$worksheet->write($a,48, "",$subt); }
					else{
						$worksheet->write($a,48, ($s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/$s->{c_retail},$subt); }
				
				$worksheet->write($a,49, "",$border1);
				$worksheet->write($a,50, "",$subt);
				$worksheet->write($a,51, "",$border1);
				$worksheet->write($a,52, "",$subt);	
				
				$worksheet->write($a,53, $s->{c_retail},$border1);
				$worksheet->write($a,54, $s->{c_margin},$border1);
					if ($s->{c_retail} le 0){
						$worksheet->write($a,55, "",$subt); }
					else{
						$worksheet->write($a,55, $s->{c_margin}/$s->{c_retail},$subt); }
				
				$worksheet->write($a,56, "",$border1);
				$worksheet->write($a,57, "",$subt);
				$worksheet->write($a,58, "",$border1);
				$worksheet->write($a,59, "",$subt);	
				
				$worksheet->write($a,60, $s->{amt434000},$border1);
				$worksheet->write($a,61, "",$border1);
				$worksheet->write($a,62, "",$border1);
				
				$worksheet->write($a,63, $s->{amt458550},$border1);
				$worksheet->write($a,64, "",$border1);
				$worksheet->write($a,65, "",$border1);
				
				$worksheet->write($a,66, $s->{amt460100},$border1);
				$worksheet->write($a,67, "",$border1);
				$worksheet->write($a,68, "",$border1);
				
				$worksheet->write($a,69, $s->{amt460200},$border1);
				$worksheet->write($a,70, "",$border1);
				$worksheet->write($a,71, "",$border1);
				
				$worksheet->write($a,72, $s->{amt460300},$border1);
				$worksheet->write($a,73, "",$border1);
				$worksheet->write($a,74, "",$border1);				
		...
		if($group_code ne 'JW'){
			...
			$grp_deb_amt432000 += $s->{deb_amt432000}, $grp_cre_amt432000 += $s->{cre_amt432000}, $grp_amt432000 += $s->{amt432000}, $grp_deb_amt433000 += $s->{deb_amt433000}, $grp_cre_amt433000 += $s->{cre_amt433000}, $grp_amt433000 += $s->{amt433000}, $grp_deb_amt458490 += $s->{deb_amt458490}, $grp_cre_amt458490 += $s->{cre_amt458490}, $grp_amt458490 += $s->{amt458490}, $grp_deb_amt434000 += $s->{deb_amt434000}, $grp_cre_amt434000 += $s->{cre_amt434000}, $grp_amt434000 += $s->{amt434000}, $grp_deb_amt458550 += $s->{deb_amt458550}, $grp_cre_amt458550 += $s->{cre_amt458550}, $grp_amt458550 += $s->{amt458550}, $grp_deb_amt460100 += $s->{deb_amt460100}, $grp_cre_amt460100 += $s->{cre_amt460100}, $grp_amt460100 += $s->{amt460100}, $grp_deb_amt460200 += $s->{deb_amt460200}, $grp_cre_amt460200 += $s->{cre_amt460200}, $grp_amt460200 += $s->{amt460200}, $grp_deb_amt460300 += $s->{deb_amt460300}, $grp_cre_amt460300 += $s->{cre_amt460300}, $grp_amt460300 += $s->{amt460300}, $grp_amt_shrnk += $s->{amt_shrnk}, $grp_amt_frt += $s->{amt_frt}, $grp_amt_addl_cost += $s->{amt_addl_cost};
		}
		
		$worksheet->write($a,7, $s->{o_retail}+$s->{c_retail},$bodyNum);
		$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$bodyNum);
			if (($s->{o_retail}+$s->{c_retail}) le 0){
				$worksheet->write($a,9, "",$bodyPct); }
			else{
				$worksheet->write($a,9, ($s->{o_margin}+$s->{c_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/($s->{o_retail}+$s->{c_retail}),$bodyPct); }
		...
		$worksheet->write($a,15, $s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490},$bodyNum);
			if ($s->{o_retail} le 0){
				$worksheet->write($a,16, "",$bodyPct); }
			else{
				$worksheet->write($a,16, ($s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490})/$s->{o_retail},$bodyPct); }
		...
		$worksheet->write($a,28, $s->{amt432000},$bodyNum);
		$worksheet->write($a,29, "",$bodyNum);
		$worksheet->write($a,30, "",$bodyNum);
				
		$worksheet->write($a,31, $s->{amt433000},$bodyNum);
		$worksheet->write($a,32, "",$bodyNum);
		$worksheet->write($a,33, "",$bodyNum);
				
		$worksheet->write($a,34, $s->{amt458490},$bodyNum);
		$worksheet->write($a,35, "",$bodyNum);
		$worksheet->write($a,36, "",$bodyNum);
			
		$worksheet->write($a,37, $s->{amt_shrnk},$bodyNum);
		$worksheet->write($a,38, "",$bodyNum);
		$worksheet->write($a,39, "",$bodyNum);
		
		$worksheet->write($a,40, $s->{amt_frt},$bodyNum);
		$worksheet->write($a,41, "",$bodyNum);
		$worksheet->write($a,42, "",$bodyNum);
		
		$worksheet->write($a,43, $s->{amt_addl_cost},$bodyNum);
		$worksheet->write($a,44, "",$bodyNum);
		$worksheet->write($a,45, "",$bodyNum);
	
		$worksheet->write($a,46, $s->{c_retail},$bodyNum);
		$worksheet->write($a,47, $s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$bodyNum);
			if ($s->{c_retail} le 0){
				$worksheet->write($a,48, "",$bodyPct); }
			else{
				$worksheet->write($a,48, ($s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/$s->{c_retail},$bodyPct); }
				
		$worksheet->write($a,49, "",$bodyNum);
		$worksheet->write($a,50, "",$bodyPct);
		$worksheet->write($a,51, "",$bodyNum);
		$worksheet->write($a,52, "",$bodyPct);	
		
		$worksheet->write($a,53, $s->{c_retail},$bodyNum);
		$worksheet->write($a,54, $s->{c_margin},$bodyNum);
			if ($s->{c_retail} le 0){
				$worksheet->write($a,55, "",$bodyPct); }
			else{
				$worksheet->write($a,55, $s->{c_margin}/$s->{c_retail},$bodyPct); }
				
		$worksheet->write($a,56, "",$bodyNum);
		$worksheet->write($a,57, "",$bodyPct);
		$worksheet->write($a,58, "",$bodyNum);
		$worksheet->write($a,59, "",$bodyPct);	
				
		$worksheet->write($a,60, $s->{amt434000},$bodyNum);
		$worksheet->write($a,61, "",$bodyNum);
		$worksheet->write($a,62, "",$bodyNum);
				
		$worksheet->write($a,63, $s->{amt458550},$bodyNum);
		$worksheet->write($a,64, "",$bodyNum);
		$worksheet->write($a,65, "",$bodyNum);
			
		$worksheet->write($a,66, $s->{amt460100},$bodyNum);
		$worksheet->write($a,67, "",$bodyNum);
		$worksheet->write($a,68, "",$bodyNum);
	
		$worksheet->write($a,69, $s->{amt460200},$bodyNum);
		$worksheet->write($a,70, "",$bodyNum);
		$worksheet->write($a,71, "",$bodyNum);
		
		$worksheet->write($a,72, $s->{amt460300},$bodyNum);
		$worksheet->write($a,73, "",$bodyNum);
		$worksheet->write($a,74, "",$bodyNum);			
	...
	$total_deb_amt432000 += $s->{deb_amt432000}, $total_cre_amt432000 += $s->{cre_amt432000}, $total_amt432000 += $s->{amt432000}, $total_deb_amt433000 += $s->{deb_amt433000}, $total_cre_amt433000 += $s->{cre_amt433000}, $total_amt433000 += $s->{amt433000}, $total_deb_amt458490 += $s->{deb_amt458490}, $total_cre_amt458490 += $s->{cre_amt458490}, $total_amt458490 += $s->{amt458490}, $total_deb_amt434000 += $s->{deb_amt434000}, $total_cre_amt434000 += $s->{cre_amt434000}, $total_amt434000 += $s->{amt434000}, $total_deb_amt458550 += $s->{deb_amt458550}, $total_cre_amt458550 += $s->{cre_amt458550}, $total_amt458550 += $s->{amt458550}, $total_deb_amt460100 += $s->{deb_amt460100}, $total_cre_amt460100 += $s->{cre_amt460100}, $total_amt460100 += $s->{amt460100}, $total_deb_amt460200 += $s->{deb_amt460200}, $total_cre_amt460200 += $s->{cre_amt460200}, $total_amt460200 += $s->{amt460200}, $total_deb_amt460300 += $s->{deb_amt460300}, $total_cre_amt460300 += $s->{cre_amt460300}, $total_amt460300 += $s->{amt460300}, $total_amt_shrnk += $s->{amt_shrnk}, $total_amt_frt += $s->{amt_frt}, $total_amt_addl_cost += $s->{amt_addl_cost};
	
	if ($merch_group_code eq 'DS'){
		############DEPT STORE WO JEWELRY ###############
		$worksheet->write($a,7, $grp_o_retail+$grp_c_retail,$headNum);
		$worksheet->write($a,8, $grp_o_margin+$grp_c_margin+$grp_amt432000+$grp_amt433000+$grp_amt458490+$grp_amt434000+$grp_amt458550+$grp_amt460100+$grp_amt460200+$grp_amt460300,$headNum);
			if (($grp_o_retail+$grp_c_retail) le 0){
				$worksheet->write($a,9, "",$headDPct); }
			else{
				$worksheet->write($a,9, ($grp_o_margin+$grp_c_margin+$grp_amt432000+$grp_amt433000+$grp_amt458490+$grp_amt434000+$grp_amt458550+$grp_amt460100+$grp_amt460200+$grp_amt460300)/($grp_o_retail+$grp_c_retail),$headDPct); }
		...
		$worksheet->write($a,15, $grp_o_margin+$grp_amt432000+$grp_amt433000+$grp_amt458490,$headNum);
			if ($grp_o_retail le 0){
				$worksheet->write($a,16, "",$headDPct); }
			else{
				$worksheet->write($a,16, ($grp_o_margin+$grp_amt432000+$grp_amt433000+$grp_amt458490)/$grp_o_retail,$headDPct); }
		...
		$worksheet->write($a,28, $grp_amt432000,$headNum);
		$worksheet->write($a,29, "",$headNum);
		$worksheet->write($a,30, "",$headNum);
		
		$worksheet->write($a,31, $grp_amt433000,$headNum);
		$worksheet->write($a,32, "",$headNum);
		$worksheet->write($a,33, "",$headNum);
		
		$worksheet->write($a,34, $grp_amt458490,$headNum);
		$worksheet->write($a,35, "",$headNum);
		$worksheet->write($a,36, "",$headNum);
		
		$worksheet->write($a,37, $grp_amt_shrnk,$headNum);
		$worksheet->write($a,38, "",$headNum);
		$worksheet->write($a,39, "",$headNum);
	
		$worksheet->write($a,40, $grp_amt_frt,$headNum);
		$worksheet->write($a,41, "",$headNum);
		$worksheet->write($a,42, "",$headNum);
		
		$worksheet->write($a,43, $grp_amt_addl_cost,$headNum);
		$worksheet->write($a,44, "",$headNum);
		$worksheet->write($a,45, "",$headNum);
	
		$worksheet->write($a,46, $grp_c_retail,$headNum);
		$worksheet->write($a,47, $grp_c_margin+$grp_amt434000+$grp_amt458550+$grp_amt460100+$grp_amt460200+$grp_amt460300,$headNum);
			if ($grp_c_retail le 0){
				$worksheet->write($a,48, "",$headDPct); }
			else{
				$worksheet->write($a,48, ($grp_c_margin+$grp_amt434000+$grp_amt458550+$grp_amt460100+$grp_amt460200+$grp_amt460300)/$grp_c_retail,$headDPct); }
		
		$worksheet->write($a,49, "",$headNum);
		$worksheet->write($a,50, "",$headDPct);
		$worksheet->write($a,51, "",$headNum);
		$worksheet->write($a,52, "",$headDPct);	
		
		$worksheet->write($a,53, $grp_c_retail,$headNum);
		$worksheet->write($a,54, $grp_c_margin,$headNum);
			if ($grp_c_retail le 0){
				$worksheet->write($a,55, "",$headDPct); }
			else{
				$worksheet->write($a,55, $grp_c_margin/$grp_c_retail,$headDPct); }
		
		$worksheet->write($a,56, "",$headNum);
		$worksheet->write($a,57, "",$headDPct);
		$worksheet->write($a,58, "",$headNum);
		$worksheet->write($a,59, "",$headDPct);	
		
		$worksheet->write($a,60, $grp_amt434000,$headNum);
		$worksheet->write($a,61, "",$headNum);
		$worksheet->write($a,62, "",$headNum);
	
		$worksheet->write($a,63, $grp_amt458550,$headNum);
		$worksheet->write($a,64, "",$headNum);
		$worksheet->write($a,65, "",$headNum);
	
		$worksheet->write($a,66, $grp_amt460100,$headNum);
		$worksheet->write($a,67, "",$headNum);
		$worksheet->write($a,68, "",$headNum);
		
		$worksheet->write($a,69, $grp_amt460200,$headNum);
		$worksheet->write($a,70, "",$headNum);
		$worksheet->write($a,71, "",$headNum);
		
		$worksheet->write($a,72, $grp_amt460300,$headNum);
		$worksheet->write($a,73, "",$headNum);
		$worksheet->write($a,74, "",$headNum);		
	...
	$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$headNumber);
		if (($s->{o_retail}+$s->{c_retail}) le 0){
			$worksheet->write($a,9, "",$headPct); }
		else{
			$worksheet->write($a,9, ($s->{o_margin}+$s->{c_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/($s->{o_retail}+$s->{c_retail}),$headPct); }
	...
	$worksheet->write($a,15, $s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490},$headNumber);
		if ($s->{o_retail} le 0){
			$worksheet->write($a,16, "",$headPct); }
		else{
			$worksheet->write($a,16, ($s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490})/$s->{o_retail},$headPct); }
	...
	$worksheet->write($a,28, $s->{amt432000},$headNumber);
	$worksheet->write($a,29, "",$headNumber);
	$worksheet->write($a,30, "",$headNumber);
	
	$worksheet->write($a,31, $s->{amt433000},$headNumber);
	$worksheet->write($a,32, "",$headNumber);
	$worksheet->write($a,33, "",$headNumber);
		
	$worksheet->write($a,34, $s->{amt458490},$headNumber);
	$worksheet->write($a,35, "",$headNumber);
	$worksheet->write($a,36, "",$headNumber);
	
	$worksheet->write($a,37, $s->{amt_shrnk},$headNumber);
	$worksheet->write($a,38, "",$headNumber);
	$worksheet->write($a,39, "",$headNumber);
	
	$worksheet->write($a,40, $s->{amt_frt},$headNumber);
	$worksheet->write($a,41, "",$headNumber);
	$worksheet->write($a,42, "",$headNumber);
	
	$worksheet->write($a,43, $s->{amt_addl_cost},$headNumber);
	$worksheet->write($a,44, "",$headNumber);
	$worksheet->write($a,45, "",$headNumber);
				
	$worksheet->write($a,46, $s->{c_retail},$headNumber);
	$worksheet->write($a,47, $s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$headNumber);
		if ($s->{c_retail} le 0){
			$worksheet->write($a,48, "",$headPct); }
		else{
			$worksheet->write($a,48, ($s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/$s->{c_retail},$headPct); }
	
	$worksheet->write($a,49, "",$headNumber);
	$worksheet->write($a,50, "",$headPct);
	$worksheet->write($a,51, "",$headNumber);
	$worksheet->write($a,52, "",$headPct);	
		
	$worksheet->write($a,53, $s->{c_retail},$headNumber);
	$worksheet->write($a,54, $s->{c_margin},$headNumber);
		if ($s->{c_retail} le 0){
			$worksheet->write($a,55, "",$headPct); }
		else{
			$worksheet->write($a,55, $s->{c_margin}/$s->{c_retail},$headPct); }
			
	$worksheet->write($a,56, "",$headNumber);
	$worksheet->write($a,57, "",$headPct);
	$worksheet->write($a,58, "",$headNumber);
	$worksheet->write($a,59, "",$headPct);	
			
	$worksheet->write($a,60, $s->{amt434000},$headNumber);
	$worksheet->write($a,61, "",$headNumber);
	$worksheet->write($a,62, "",$headNumber);
			
	$worksheet->write($a,63, $s->{amt458550},$headNumber);
	$worksheet->write($a,64, "",$headNumber);
	$worksheet->write($a,65, "",$headNumber);

	$worksheet->write($a,66, $s->{amt460100},$headNumber);
	$worksheet->write($a,67, "",$headNumber);
	$worksheet->write($a,68, "",$headNumber);
				
	$worksheet->write($a,69, $s->{amt460200},$headNumber);
	$worksheet->write($a,70, "",$headNumber);
	$worksheet->write($a,71, "",$headNumber);
			
	$worksheet->write($a,72, $s->{amt460300},$headNumber);
	$worksheet->write($a,73, "",$headNumber);
	$worksheet->write($a,74, "",$headNumber);			
	
	$a++; #INCREMENT VARIABLE a
}

	$worksheet->write($a,7, $total_o_retail+$total_c_retail,$headNumber);
	$worksheet->write($a,8, $total_o_margin+$total_c_margin+$total_amt432000+$total_amt433000+$total_amt458490+$total_amt434000+$total_amt458550+$total_amt460100+$total_amt460200+$total_amt460300,$headNumber);
			if (($total_o_retail+$total_c_retail) le 0){
				$worksheet->write($a,9, "",$headPct); }
			else{
				$worksheet->write($a,9, ($total_o_margin+$total_c_margin+$total_amt432000+$total_amt433000+$total_amt458490+$total_amt434000+$total_amt458550+$total_amt460100+$total_amt460200+$total_amt460300)/($total_o_retail+$total_c_retail),$headPct); }
	...
	$worksheet->write($a,15, $total_o_margin+$total_amt432000+$total_amt433000+$total_amt458490,$headNumber);
		if ($total_o_retail le 0){
			$worksheet->write($a,16, "",$headPct); }
		else{
			$worksheet->write($a,16, ($total_o_margin+$total_amt432000+$total_amt433000+$total_amt458490)/$total_o_retail,$headPct); }
	...
	$worksheet->write($a,28, $total_amt432000,$headNumber);
	$worksheet->write($a,29, "",$headNumber);
	$worksheet->write($a,30, "",$headNumber);
	
	$worksheet->write($a,31, $total_amt433000,$headNumber);
	$worksheet->write($a,32, "",$headNumber);
	$worksheet->write($a,33, "",$headNumber);
	
	$worksheet->write($a,34, $total_amt458490,$headNumber);
	$worksheet->write($a,35, "",$headNumber);
	$worksheet->write($a,36, "",$headNumber);
	
	$worksheet->write($a,37, $total_amt_shrnk,$headNumber);
	$worksheet->write($a,38, "",$headNumber);
	$worksheet->write($a,39, "",$headNumber);
	
	$worksheet->write($a,40, $total_amt_frt,$headNumber);
	$worksheet->write($a,41, "",$headNumber);
	$worksheet->write($a,42, "",$headNumber);
	
	$worksheet->write($a,43, $total_amt_addl_cost,$headNumber);
	$worksheet->write($a,44, "",$headNumber);
	$worksheet->write($a,45, "",$headNumber);
	
	$worksheet->write($a,46, $total_c_retail,$headNumber);
	$worksheet->write($a,47, $total_c_margin+$total_amt434000+$total_amt458550+$total_amt460100+$total_amt460200+$total_amt460300,$headNumber);
		if ($total_c_retail le 0){
			$worksheet->write($a,48, "",$headPct); }
		else{
			$worksheet->write($a,48, ($total_c_margin+$total_amt434000+$total_amt458550+$total_amt460100+$total_amt460200+$total_amt460300)/$total_c_retail,$headPct); }
	...
	$worksheet->write($a,53, $total_c_retail,$headNumber);
	$worksheet->write($a,54, $total_c_margin,$headNumber);
		if ($total_c_retail le 0){
			$worksheet->write($a,55, "",$headPct); }
		else{
			$worksheet->write($a,55, $total_c_margin/$total_c_retail,$headPct); }
	...
	$worksheet->write($a,60, $total_amt434000,$headNumber);
	$worksheet->write($a,61, "",$headNumber);
	$worksheet->write($a,62, "",$headNumber);
	
	$worksheet->write($a,63, $total_amt458550,$headNumber);
	$worksheet->write($a,64, "",$headNumber);
	$worksheet->write($a,65, "",$headNumber);
	
	$worksheet->write($a,66, $total_amt460100,$headNumber);
	$worksheet->write($a,67, "",$headNumber);
	$worksheet->write($a,68, "",$headNumber);

	$worksheet->write($a,69, $total_amt460200,$headNumber);
	$worksheet->write($a,70, "",$headNumber);
	$worksheet->write($a,71, "",$headNumber);
	
	$worksheet->write($a,72, $total_amt460300,$headNumber);
	$worksheet->write($a,73, "",$headNumber);
	$worksheet->write($a,74, "",$headNumber);			
...
while(my $s = $sls->fetchrow_hashref()){
		...
		$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$border1); # total margin
		...
		$worksheet->write($a,15, $s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490},$border1); #outright margin
			if ($s->{o_retail} <= 0){
				$worksheet->write($a,16, "",$subt); }
			else{
				$worksheet->write($a,16, ($s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490})/$s->{o_retail},$subt); }
...
while(my $s = $sls->fetchrow_hashref()){
	...
	if($s1f2_counter ne 2){
		...
		$worksheet->write($a,74, "",$border1);	
			...
			if ($mrch1 eq 'SU' and $mrch2 eq 'SU' and ($s->{store_code} eq '2001' or $s->{store_code} eq '2001W')) {
				$s1f2_deb_amt432000 += $s->{deb_amt432000}, $s1f2_cre_amt432000 += $s->{cre_amt432000}, $s1f2_amt432000 += $s->{amt432000}, $s1f2_deb_amt433000 += $s->{deb_amt433000}, $s1f2_cre_amt433000 += $s->{cre_amt433000}, $s1f2_amt433000 += $s->{amt433000}, $s1f2_deb_amt458490 += $s->{deb_amt458490}, $s1f2_cre_amt458490 += $s->{cre_amt458490}, $s1f2_amt458490 += $s->{amt458490}, $s1f2_deb_amt434000 += $s->{deb_amt434000}, $s1f2_cre_amt434000 += $s->{cre_amt434000}, $s1f2_amt434000 += $s->{amt434000}, $s1f2_deb_amt458550 += $s->{deb_amt458550}, $s1f2_cre_amt458550 += $s->{cre_amt458550}, $s1f2_amt458550 += $s->{amt458550}, $s1f2_deb_amt460100 += $s->{deb_amt460100}, $s1f2_cre_amt460100 += $s->{cre_amt460100}, $s1f2_amt460100 += $s->{amt460100}, $s1f2_deb_amt460200 += $s->{deb_amt460200}, $s1f2_cre_amt460200 += $s->{cre_amt460200}, $s1f2_amt460200 += $s->{amt460200}, $s1f2_deb_amt460300 += $s->{deb_amt460300}, $s1f2_cre_amt460300 += $s->{cre_amt460300}, $s1f2_amt460300 += $s->{amt460300}, $s1f2_amt_shrnk += $s->{amt_shrnk}, $s1f2_amt_frt += $s->{amt_frt}, $s1f2_amt_addl_cost += $s->{amt_addl_cost};
	...
	if($s1f2_counter eq 2){
		...
		$worksheet->write($a,8, $s1f2_o_margin+$s1f2_c_margin+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt434000+$s1f2_amt458550+$s1f2_amt460100+$s1f2_amt460200+$s1f2_amt460300,$border1);
			if (($s1f2_o_retail+$s1f2_c_retail) <= 0){
				$worksheet->write($a,9, "",$subt); }
			else{
				$worksheet->write($a,9, ($s1f2_o_margin+$s1f2_c_margin+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490+$s1f2_amt434000+$s1f2_amt458550+$s1f2_amt460100+$s1f2_amt460200+$s1f2_amt460300)/($s1f2_o_retail+$s1f2_c_retail),$subt); }
		...
		$worksheet->write($a,15, $s1f2_o_margin+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490,$border1);
			if ($s1f2_o_retail <= 0){
				$worksheet->write($a,16, "",$subt); }
			else{
				$worksheet->write($a,16, ($s1f2_o_margin+$s1f2_amt432000+$s1f2_amt433000+$s1f2_amt458490)/$s1f2_o_retail,$subt); }
		...
		$worksheet->write($a,28, $s1f2_amt432000,$border1);
		$worksheet->write($a,29, "",$border1);
		$worksheet->write($a,30, "",$border1);
		
		$worksheet->write($a,31, $s1f2_amt433000,$border1);
		$worksheet->write($a,32, "",$border1);
		$worksheet->write($a,33, "",$border1);
		
		$worksheet->write($a,34, $s1f2_amt458490,$border1);
		$worksheet->write($a,35, "",$border1);
		$worksheet->write($a,36, "",$border1);
		
		$worksheet->write($a,37, $s1f2_amt_shrnk,$border);
		$worksheet->write($a,38, "",$border1);
		$worksheet->write($a,39, "",$border1);
	
		$worksheet->write($a,40, $s1f2_amt_frt,$border1);
		$worksheet->write($a,41, "",$border1);
		$worksheet->write($a,42, "",$border1);
		
		$worksheet->write($a,43, $s1f2_amt_addl_cost,$border1);
		$worksheet->write($a,44, "",$border1);
		$worksheet->write($a,45, "",$border1);
		
		$worksheet->write($a,46, $s1f2_c_retail,$border1);
		$worksheet->write($a,47, $s1f2_c_margin+$s1f2_amt434000+$s1f2_amt458550+$s1f2_amt460100+$s1f2_amt460200+$s1f2_amt460300,$border1);
			if ($s1f2_c_retail <= 0){
				$worksheet->write($a,48, "",$subt); }
			else{
				$worksheet->write($a,48, ($s1f2_c_margin+$s1f2_amt434000+$s1f2_amt458550+$s1f2_amt460100+$s1f2_amt460200+$s1f2_amt460300)/$s1f2_c_retail,$subt); }
		...
		$worksheet->write($a,53, $s1f2_c_retail,$border1);
		$worksheet->write($a,54, $s1f2_c_margin,$border1);
			if ($s1f2_c_retail <= 0){
				$worksheet->write($a,55, "",$subt); }
			else{
				$worksheet->write($a,55, $s1f2_c_margin/$s1f2_c_retail,$subt); }
		...
		$worksheet->write($a,60, $s1f2_amt434000,$border1);
		$worksheet->write($a,61, "",$border1);
		$worksheet->write($a,62, "",$border1);
		
		$worksheet->write($a,63, $s1f2_amt458550,$border1);
		$worksheet->write($a,64, "",$border1);
		$worksheet->write($a,65, "",$border1);
	
		$worksheet->write($a,66, $s1f2_amt460100,$border1);
		$worksheet->write($a,67, "",$border1);
		$worksheet->write($a,68, "",$border1);
		
		$worksheet->write($a,69, $s1f2_amt460200,$border1);
		$worksheet->write($a,70, "",$border1);
		$worksheet->write($a,71, "",$border1);
		
		$worksheet->write($a,72, $s1f2_amt460300,$border1);
		$worksheet->write($a,73, "",$border1);
		$worksheet->write($a,74, "",$border1);
...
$sls = $dbh_csv->prepare (qq{SELECT store_description, SUM(otr_cost) AS o_cost, SUM(otr_retail) AS o_retail, SUM(otr_margin) AS o_margin, SUM(con_cost) AS c_cost, SUM(con_retail) AS c_retail, SUM(con_margin) AS c_margin, SUM(debit_amt432000) AS deb_amt432000, SUM(credit_amt432000) AS cre_amt432000, SUM(amount432000) AS amt432000, SUM(debit_amt433000) AS deb_amt433000, SUM(credit_amt433000) AS cre_amt433000, SUM(amount433000) AS amt433000, SUM(debit_amt458490) AS deb_amt458490, SUM(credit_amt458490) AS cre_amt458490, SUM(amount458490) AS amt458490, SUM(debit_amt434000) AS deb_amt434000, SUM(credit_amt434000) AS cre_amt434000, SUM(amount434000) AS amt434000, SUM(debit_amt458550) AS deb_amt458550, SUM(credit_amt458550) AS cre_amt458550, SUM(amount458550) AS amt458550, SUM(debit_amt460100) AS deb_amt460100, SUM(credit_amt460100) AS cre_amt460100, SUM(amount460100) AS amt460100, SUM(debit_amt460200) AS deb_amt460200, SUM(credit_amt460200) AS cre_amt460200, SUM(amount460200) AS amt460200, SUM(debit_amt460300) AS deb_amt460300, SUM(credit_amt460300) AS cre_amt460300, SUM(amount460300) AS amt460300
								 FROM $table 
								 WHERE ((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
																		(division = '$division_grp2' and (department_code = '$dept_grp1' or department_code = '$dept_grp2' 
																										or department_code = '$dept_grp3' or department_code = '$dept_grp4' 
...
if ($mrch1 eq 'DS' and $mrch2 eq 'DS' and $mrch3 eq 'OT' ){
	...
	while(my $s = $sls->fetchrow_hashref()){
		$worksheet->merge_range( $a, 4, $a, 6, $div_name3, $desc );
		$worksheet->write($a,7, $s->{o_retail}+$s->{c_retail},$border1);
		$worksheet->write($a,8, $s->{o_margin}+$s->{c_margin},$border1);
			if (($s->{o_retail}+$s->{c_retail}) <= 0){
				$worksheet->write($a,9, "",$subt); }
			else{
				$worksheet->write($a,9, ($s->{o_margin}+$s->{c_margin})/($s->{o_retail}+$s->{c_retail}),$subt); }
		...
		$worksheet->write($a,14, $s->{o_retail},$border1);
		$worksheet->write($a,15, $s->{o_margin},$border1);
			if ($s->{o_retail} <= 0){
				$worksheet->write($a,16, "",$subt); }
			else{
				$worksheet->write($a,16, $s->{o_margin}/$s->{o_retail},$subt); }
		...
		$worksheet->write($a,21, $s->{o_retail},$border1);
		$worksheet->write($a,22, $s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490},$border1);
			if ($s->{c_retail} <= 0){
				$worksheet->write($a,23, "",$subt); }
			else{
				$worksheet->write($a,23, ($s->{o_margin}+$s->{amt432000}+$s->{amt433000}+$s->{amt458490})/$s->{o_retail},$subt); }
		...
		$worksheet->write($a,31, $s->{amt433000},$subt);
		$worksheet->write($a,32, "",$border1);
		$worksheet->write($a,33, "",$border1);
		...
		$worksheet->write($a,43, $s->{c_retail},$border1);
		$worksheet->write($a,44, $s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300},$border1);
			if ($s->{c_retail} <= 0){
				$worksheet->write($a,45, "",$subt); }
			else{
				$worksheet->write($a,45, ($s->{c_margin}+$s->{amt434000}+$s->{amt458550}+$s->{amt460100}+$s->{amt460200}+$s->{amt460300})/$s->{c_retail},$subt); }
		
		$worksheet->write($a,46, "",$border1);
		$worksheet->write($a,47, "",$subt);
		$worksheet->write($a,48, "",$border1);
		$worksheet->write($a,49, "",$subt);	
		
		$worksheet->write($a,50, $s->{c_retail},$border1);
		$worksheet->write($a,51, $s->{c_margin},$border1);
			if ($s->{c_retail} <= 0){
				$worksheet->write($a,52, "",$subt); }
			else{
				$worksheet->write($a,52, $s->{c_margin}/$s->{c_retail},$subt); }
		
		$worksheet->write($a,53, "",$border1);
		$worksheet->write($a,54, "",$subt);
		$worksheet->write($a,55, "",$border1);
		$worksheet->write($a,56, "",$subt);	
		
		$worksheet->write($a,57, $s->{amt434000},$border1);
		$worksheet->write($a,58, "",$border1);
		$worksheet->write($a,59, "",$border1);
		
		$worksheet->write($a,60, $s->{amt458550},$subt);
		$worksheet->write($a,61, "",$border1);
		$worksheet->write($a,63, "",$border1);
		
		$worksheet->write($a,63, $s->{amt460100},$border1);
		$worksheet->write($a,64, "",$border1);
		$worksheet->write($a,65, "",$border1);
		
		$worksheet->write($a,66, $s->{amt460200},$border1);
		$worksheet->write($a,67, "",$border1);
		$worksheet->write($a,68, "",$border1);
		
		$worksheet->write($a,69, $s->{amt460300},$border1);
		$worksheet->write($a,70, "",$border1);
		$worksheet->write($a,71, "",$border1);
	...
	$sls_2 = $dbh_csv->prepare (qq{SELECT merch_group_code_rev, store_description, SUM(otr_cost) AS o_cost, SUM(otr_retail) AS o_retail, SUM(otr_margin) AS o_margin, SUM(con_cost) AS c_cost, SUM(con_retail) AS c_retail, SUM(con_margin) AS c_margin, SUM(debit_amt432000) AS deb_amt432000, SUM(credit_amt432000) AS cre_amt432000, SUM(amount432000) AS amt432000, SUM(debit_amt433000) AS deb_amt433000, SUM(credit_amt433000) AS cre_amt433000, SUM(amount433000) AS amt433000, SUM(debit_amt458490) AS deb_amt458490, SUM(credit_amt458490) AS cre_amt458490, SUM(amount458490) AS amt458490, SUM(debit_amt434000) AS deb_amt434000, SUM(credit_amt434000) AS cre_amt434000, SUM(amount434000) AS amt434000, SUM(debit_amt458550) AS deb_amt458550, SUM(credit_amt458550) AS cre_amt458550, SUM(amount458550) AS amt458550, SUM(debit_amt460100) AS deb_amt460100, SUM(credit_amt460100) AS cre_amt460100, SUM(amount460100) AS amt460100, SUM(debit_amt460200) AS deb_amt460200, SUM(credit_amt460200) AS cre_amt460200, SUM(amount460200) AS amt460200, SUM(debit_amt460300) AS deb_amt460300, SUM(credit_amt460300) AS cre_amt460300, SUM(amount460300) AS amt460300
								 FROM $table 
								 WHERE ((merch_group_code = '$mrch3' and (division = '$division_grp1' or 
																		(division = '$division_grp2' and (department_code = '$dept_grp1' or department_code = '$dept_grp2' 
																										or department_code = '$dept_grp3' or department_code = '$dept_grp4' 
...
$worksheet->conditional_formatting( 'H44:FE60', { type     => 'cell',  criteria => '=', value    => 0, format   => $blank });	
...
(SUM(SHRNK.DEBIT_AMT_SHRNK)/1000) DEBIT_AMT_SHRNK, (SUM(SHRNK.CREDIT_AMT_SHRNK)/1000) CREDIT_AMT_SHRNK, (SUM(SHRNK.AMOUNT_SHRNK)/1000) AMOUNT_SHRNK,
(SUM(FRT.DEBIT_AMT_FRT)/1000) DEBIT_AMT_FRT, (SUM(FRT.CREDIT_AMT_FRT)/1000) CREDIT_AMT_FRT, (SUM(FRT.AMOUNT_FRT)/1000) AMOUNT_FRT,
(SUM(ADDL_COST.DEBIT_AMT_ADDL_COST)/1000) DEBIT_AMT_ADDL_COST, (SUM(ADDL_COST.CREDIT_AMT_ADDL_COST)/1000) CREDIT_AMT_ADDL_COST, (SUM(ADDL_COST.AMOUNT_ADDL_COST)/1000) AMOUNT_ADDL_COST,
...
FROM
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) OTR_UNITS, SUM(T.OTR_COST) OTR_COST, SUM(T.OTR_RETAIL) OTR_RETAIL, SUM((NVL(T.OTR_RETAIL,0))-(NVL(T.TOTAL_COST,0))) OTR_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST OTR_COST, TDH.TOTAL_RETAIL OTR_RETAIL, 
			...
			WHERE (TDH.TRAN_DATE BETWEEN \'01-OCT-14\' AND \'31-OCT-14\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 0)T
	...
	(SELECT T.LOCATION, T.GROUP_NO, SUM(T.UNITS) CON_UNITS, SUM(T.CON_COST) CON_COST, SUM(T.CON_RETAIL) CON_RETAIL, SUM((NVL(T.CON_RETAIL,0))-(NVL(T.TOTAL_COST,0))) CON_MARGIN FROM
		(SELECT TDH.LOCATION, DEPS.GROUP_NO, TDH.UNITS UNITS, TDH.TOTAL_COST CON_COST, TDH.TOTAL_RETAIL CON_RETAIL, 
			...
			FROM TRAN_DATA_HISTORY_BUP TDH 
				JOIN DEPS ON TDH.DEPT = DEPS.DEPT
			WHERE (TDH.TRAN_DATE BETWEEN \'01-OCT-14\' AND \'31-OCT-14\') AND TDH.TRAN_CODE = 1 AND DEPS.PURCHASE_TYPE = 2)T
	GROUP BY T.LOCATION, T.GROUP_NO)CON
	ON SGD.STORE = CON.LOCATION AND SGD.GROUP_NO = CON.GROUP_NO
	
	LEFT JOIN
	(SELECT CC.SEGMENT5 ACCOUNT, MG.RMS_LOC_NO STORE, CASE WHEN TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = 0000 THEN 0 WHEN G.GROUP_NO IS NULL THEN 999 ELSE G.GROUP_NO END AS DEPARTMENT, SUM(NVL(L.ACCOUNTED_DR,0)) DEBIT_AMT_SHRNK, SUM(NVL(L.ACCOUNTED_CR,0)) CREDIT_AMT_SHRNK,
	SUM(NVL(L.ACCOUNTED_CR,0)-NVL(L.ACCOUNTED_DR,0)) AMOUNT_SHRNK
	...
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
	...
	GROUP BY CC.SEGMENT5, MG.RMS_LOC_NO, CASE WHEN TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = 0000 THEN 0 WHEN G.GROUP_NO IS NULL THEN 999 ELSE G.GROUP_NO END)SHRNK
	ON SGD.STORE = SHRNK.STORE AND SGD.GROUP_NO = SHRNK.DEPARTMENT
	
	LEFT JOIN
	(SELECT CC.SEGMENT5 ACCOUNT, MG.RMS_LOC_NO STORE, CASE WHEN TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = 0000 THEN 0 WHEN G.GROUP_NO IS NULL THEN 999 ELSE G.GROUP_NO END AS DEPARTMENT, SUM(NVL(L.ACCOUNTED_DR,0)) DEBIT_AMT_FRT, SUM(NVL(L.ACCOUNTED_CR,0)) CREDIT_AMT_FRT,
	SUM(NVL(L.ACCOUNTED_CR,0)-NVL(L.ACCOUNTED_DR,0)) AMOUNT_FRT
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		JOIN GL_JE_LINES@RMS_FIN_DBLINK L ON H.JE_HEADER_ID = L.JE_HEADER_ID 
		JOIN GL_JE_BATCHES@RMS_FIN_DBLINK B ON B.JE_BATCH_ID=H.JE_BATCH_ID
		JOIN GL_CODE_COMBINATIONS@RMS_FIN_DBLINK CC ON CC.CODE_COMBINATION_ID=L.CODE_COMBINATION_ID 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'505000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	GROUP BY CC.SEGMENT5, MG.RMS_LOC_NO, CASE WHEN TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = 0000 THEN 0 WHEN G.GROUP_NO IS NULL THEN 999 ELSE G.GROUP_NO END)FRT
	ON SGD.STORE = FRT.STORE AND SGD.GROUP_NO = FRT.DEPARTMENT
	
	LEFT JOIN
	(SELECT MG.RMS_LOC_NO STORE, CASE WHEN TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = 0000 THEN 0 WHEN G.GROUP_NO IS NULL THEN 999 ELSE G.GROUP_NO END AS DEPARTMENT, SUM(NVL(L.ACCOUNTED_DR,0)) DEBIT_AMT_ADDL_COST, SUM(NVL(L.ACCOUNTED_CR,0)) CREDIT_AMT_ADDL_COST,
	SUM(NVL(L.ACCOUNTED_CR,0)-NVL(L.ACCOUNTED_DR,0)) AMOUNT_ADDL_COST
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		JOIN GL_JE_LINES@RMS_FIN_DBLINK L ON H.JE_HEADER_ID = L.JE_HEADER_ID 
		JOIN GL_JE_BATCHES@RMS_FIN_DBLINK B ON B.JE_BATCH_ID=H.JE_BATCH_ID
		JOIN GL_CODE_COMBINATIONS@RMS_FIN_DBLINK CC ON CC.CODE_COMBINATION_ID=L.CODE_COMBINATION_ID 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'503200\',\'503250\',\'503500\',\'506000\',\'507000\',\'999998\') AND CC.SEGMENT1=\'240\' AND H.PERIOD_NAME=\'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	GROUP BY MG.RMS_LOC_NO, CASE WHEN TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = 0000 THEN 0 WHEN G.GROUP_NO IS NULL THEN 999 ELSE G.GROUP_NO END)ADDL_COST
	ON SGD.STORE = ADDL_COST.STORE AND SGD.GROUP_NO = ADDL_COST.DEPARTMENT
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
	    ...
	    LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'432000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'433000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'458490\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'434000\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'458550\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460100\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460200\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
	...
	FROM GL_JE_HEADERS@RMS_FIN_DBLINK H 
		...
		LEFT JOIN MG_COMP_LOC_MAPPING MG ON CC.SEGMENT2 = MG.COA_SITE
		LEFT JOIN GROUPS G ON TRANSLATE(CC.SEGMENT4, \'1abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\', \'1\') = G.GROUP_NO
	WHERE H.ACTUAL_FLAG=\'A\' AND CC.SEGMENT5 IN (\'460300\') AND CC.SEGMENT1 = \'240\' AND H.PERIOD_NAME = \'OCT-14\' 
		AND H.ACCRUAL_REV_STATUS IS NULL AND H.STATUS=\'P\' 
		--H.DEFAULT_EFFECTIVE_DATE > \'01-JUN-13\' --BETWEEN \'01-JAN-10\' AND \'31-DEC-10\'--AND H.POSTED_DATE BETWEEN \'06-APR-2014\' AND \'12-MAY-2014\'
