...
#change date here	
	...
	$workbook = Excel::Writer::XLSX->new("TOTAL MARGIN PERFORMANCE FOR CENTRAL LUZON (as of $as_of) v1.7.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "TOTAL MARGIN PERFORMANCE FOR CENTRAL LUZON (as of } . $as_of . q{) v1.7.xlsx" pdf});
	$pdf_job_1->run(1500);	
...
$worksheet->write($a-9, 2, "Total Margin Performance for Central Luzon (2004, 2005, 6011, 6013)", $bold1);
...
$worksheet->write($a-9, 3, "Total Margin Performance for Central Luzon (2004, 2005, 6011, 6013)", $bold1);
...
$worksheet->write($a-10, 3, "Total Margin Performance for Central Luzon (2004, 2005, 6011, 6013)", $bold1);
...
$to = 'joseph.landicho@metroretail.com.ph';
...
$subject = 'Total Margin Performance for Central Luzon ' . $as_of;

$msgbody_file = 'message_margin.txt';

$attachment_file_1 = "TOTAL MARGIN PERFORMANCE FOR CENTRAL LUZON (as of $as_of) v1.7.xlsx";
$attachment_file_2 = "TOTAL MARGIN PERFORMANCE FOR CENTRAL LUZON (as of $as_of) v1.7.pdf";
...
<html>
Hi All, <br> <br>
Please see attached TOTAL MARGIN PERFORMANCE FOR CENTRAL LUZON Report. <br> <br>
