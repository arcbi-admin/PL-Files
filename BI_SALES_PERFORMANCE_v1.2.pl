...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary (as of $as_of) v1.2.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Daily Sales Performance - Summary (as of } . $as_of . q{) v1.2.xlsx" pdf});
	$pdf_job_1->run(60);	
...
$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v1.2.xlsx";
$attachment_file_2 = "Daily Sales Performance - Summary (as of $as_of) v1.2.pdf";
...
# $attachment_file_1 = "Daily Sales Performance (as of $as_of) v2.xlsx";
# $attachment_file_2 = "Daily Sales Performance (as of $as_of) v2.pdf";
$attachment_file_1 = "Daily Sales Performance - Summary (as of $as_of) v2.xlsx";
$attachment_file_2 = "Daily Sales Performance - Summary (as of $as_of) v2.pdf";
