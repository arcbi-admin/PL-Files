...
if ($test eq 1){
	...
	SELECT WTD_ST_DT, WTD_ST_DT_LY, WTD_EN_DT, WTD_EN_DT_LY FROM
		(SELECT TO_CHAR(DATE_FLD, 'DD Mon YYYY') AS WTD_ST_DT, TO_CHAR(DATE_FLD_LY, 'DD Mon YYYY') AS WTD_ST_DT_LY 
			FROM DIM_DATE WHERE DATE_KEY = (SELECT WEEK_ST_DATE_KEY FROM DIM_DATE WHERE TRUNC(DATE_FLD) = TRUNC((SELECT DISTINCT UPDATE_DATE FROM LUZON_METRO_IT_SALES_DEPT_WTD)-1))),
	...
	$workbook = Excel::Writer::XLSX->new("Luzon_Daily Sales Performance - Summary (as of $as_of) v1.7.xlsx");
	...
	$pdf_job_1->spawn( "cmd" , q{cmd /C java ecp_FileConverter "Luzon_Daily Sales Performance - Summary (as of } . $as_of . q{) v1.7.xlsx" pdf});
	$pdf_job_1->run(60);	
...
$worksheet->write($a-11, 2, "Luzon_Daily Sales Performance", $bold1);
...
$worksheet->write($a-11, 3, "Luzon_Daily Sales Performance", $bold1);
...
print "Deleted old records from table LUZON_METRO_IT_SALES_DEPT_WTD... \nPreparing to insert new data... \n";

$test = qq{ 

INSERT /*+ APPEND */ INTO LUZON_METRO_IT_SALES_DEPT_WTD
...
#$to = ' arthur.emmanuel@metrogaisano.com, frank.gaisano@metrogaisano.com, gerry.guanlao@metrogaisano.com, eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, jj.moreno@metrogaisano.com, rose.jose@metrogaisano.com, rex.cabanilla@metrogaisano.com, margaret.ang@metrogaisano.com  ';

#$bcc = ' kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, frank.naquines@metrogaisano.com, cham.burgos@metrogaisano.com, arlene.valdez@metrogaisano.com, rashel.legaspi@metrogaisano.com  ';
#$bcc = 'lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, frank.naquines@metrogaisano.com, cham.burgos@metrogaisano.com, arlene.valdez@metrogaisano.com, rashel.legaspi@metrogaisano.com  ';
...
$subject = 'Luzon_Daily Sales Performance as of ' . $as_of;

$msgbody_file = 'message_BI.txt';

$attachment_file_1 = "Luzon_Daily Sales Performance - Summary (as of $as_of) v1.7.xlsx";
$attachment_file_2 = "Luzon_Daily Sales Performance - Summary (as of $as_of) v1.7.pdf";
