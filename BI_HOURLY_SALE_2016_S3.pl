...
FROM
	...
	AND TO_NUMBER(H.ID_STR_RT) = '2003'	
...
$subject = 'S3:Hourly Sales Performance as of ' . $update_time;
...
<html>
<b><font size="4">Metro  Ayala: END OF SUMMER SALE</font></b>
<br>
