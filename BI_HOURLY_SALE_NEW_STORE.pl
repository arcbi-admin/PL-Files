...
FROM
	...
	AND TO_NUMBER(H.ID_STR_RT) IN ('6011') AND H.TS_RTN_HR <= (SELECT TO_CHAR(SYSDATE, 'HH24') NEW_TIME FROM DUAL)
...
$table->setRowBGColor(51, '#E0FFFF');	
$table->setRowBGColor(52, '#E0FFFF');	
$table->setRowBGColor(53, '#E0FFFF');	
$table->setRowBGColor(54, '#E0FFFF');	
$table->setRowBGColor(55, '#E0FFFF');	
...
$table->setRowBGColor(72, '#E0FFFF');
$table->setRowBGColor(73, '#E0FFFF');

$table->setRowBGColor(74, '#E0FFFF');
...
$to = ' chit.lazaro@metrogaisano.com, fili.mercado@metrogaisano.com, karan.malani@metrogaisano.com, lia.chipeco@metrogaisano.com, marlita.portes@metrogaisano.com, jennifer.yu@metrogaisano.com, april.agapito@metrogaisano.com, edna.prieto@metrogaisano.com, tessie.baldezamo@metrogaisano.com, chedie.lim@metrogaisano.com, liberato.rodriguez@metrogaisano.com,luz.bitang@metrogaisano.com, emily.silverio@metrogaisano.com, julie.montano@metrogaisano.com, limuel.ulanday@metrogaisano.com, delia.jakosalem@metrogaisano.com,Eric.redona@metrogaisano.com ,irene.babylonia@metrogaisano.com, arthur.emmanuel@metrogaisano.com';

$cc = 'rex.cabanilla@metrogaisano.com, annalyn.conde@metrogaisano.com,roel.gevana@metrogaisano.com,wendell.manumbaga@metrogaisano.com,bernadette.rosell@metroretail.com.ph';
...
<html>
<b><font size="4">Super Metro Calamba: Hourly Sales Report</font></b>
