...
##REVISED QUERY, IMPROVEMENTS ON GROUPING OF DOUBLE DISPLAY ITEMS 
...
if ($test eq 1){
	...
	$workbook = Excel::Writer::XLSX->new("Daily Sales Performance - Summary-DoubleDisplay (as of $as_of) v1.7.xlsx");
...
&heading_2;
&heading;
&query_dept($new_flg1 = 0, $new_flg2 = 0, $matured_flg1 = 1, $matured_flg2 = 1, $loc_desc = "COMP STORES", $wtd_net_ly = 0, $mtd_net_ly = 0, $qtd_net_ly = 0);
...
&heading_2;
&heading;
&query_dept($new_flg1 = 0, $new_flg2 = 1, $matured_flg1 = 0, $matured_flg2 = 1, $loc_desc = "ALL STORES", $wtd_net_ly = 0, $mtd_net_ly = 0, $qtd_net_ly = 0);
...
$wtd_net_ly = 0, $mtd_net_ly = 0, $qtd_net_ly = 0;
&strComp_Ds;
&strComp_Su;
&strComp_Hy;
&strComp_Nb;
...
$stor1 = '3001'; $stor2 = '3007'; $stor3 = '4003'; $stor4 = '3002'; $stor5 = '3003'; $stor6 = '3004'; $stor7 = '3005'; $stor8 = '3006'; $stor9 = '0000'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';    $stor14 = '0000';  $stor15 = '0000'; 
...
$stor1 = '0000'; $stor2 = '0000'; $stor3 = '0000'; $stor4 = '6004'; $stor5 = '0000'; $stor6 = '6012'; $stor7 = '6009'; $stor8 = '0000'; $stor9 = '0000'; $stor10 = '0000'; $stor11 = '0000'; $stor12 = '0000';  $stor13 = '0000';   $stor14 = '0000';   $stor15 = '0000'; 
...
$stor1 = '2001'; $stor2 = '2002'; $stor3 = '2003'; $stor4 = '2004'; $stor5 = '2006'; $stor6 = '2007'; $stor7 = '2009'; $stor8 = '2013'; $stor9 = '2012'; $stor10 = '4004'; $stor11 = '3009'; $stor12 = '0000';  $stor13 = '0000';    $stor14 = '2001W';  $stor15 = '3012'; 
...
$stor1 = '6001'; $stor2 = '6002'; $stor3 = '6003'; $stor4 = '6004'; $stor5 = '6005'; $stor6 = '6012'; $stor7 = '6009'; $stor8 = '6010'; $stor9 = '0000'; $stor10 = '2005'; $stor11 = '2008'; $stor12 = '2010';  $stor13 = '2011';    $stor14 = '0000';  $stor15 = '0000'; 
...
$sls = $dbh_csv->prepare (qq{SELECT SUM(target_sale_val) AS wtd_target, SUM(net_sale_ty) AS wtd_net_ty, SUM(net_sale_ly) AS wtd_net_ly, SUM(mtd_target_sale_val) AS mtd_target, SUM(mtd_net_sale_ty) AS mtd_net_ty, SUM(mtd_net_sale_ly) AS mtd_net_ly, SUM(qtd_target_sale_val) AS qtd_target, SUM(qtd_net_sale_ty) AS qtd_net_ty, SUM(qtd_net_sale_ly) AS qtd_net_ly
								 FROM $table 
								 WHERE (business_unit = '$mrch1' or business_unit = '$mrch2' or business_unit = '$mrch3') 
									and (store_code = '$stor1' or store_code = '$stor2' or store_code = '$stor3' or store_code = '$stor4' or store_code = '$stor5' 
										...
										or store_code = '$stor15') and (merch_group_code_rev <> 'Z_OT') 									
								});
$sls->execute();
...
$worksheet->conditional_formatting( 'H17:AF20', { type     => 'cell',  criteria => '=', value    => 0, format   => $blank });				
...
$blank = $workbook->add_format( border => 1, align => 'center', valign => 'right', size => 10, hidden => 1 );
$worksheet->conditional_formatting( 'H43:AF60', { type     => 'cell',  criteria => '=', value    => 0, format   => $blank });	
...
my $csv = Text::CSV_XS->new ({ binary => 1, eol => $/ });
 open my $fh, ">", "bi_sales_perf_17.csv" or die "bi_sales_perf_17.csv: $!";

$test = qq{ 
SELECT STORE_FORMAT, STORE_FORMAT_DESC, STORE_CODE, STORE, STORE_DESCRIPTION, 
CASE WHEN STORE_CODE IN ('2012', '2013', '3009', '4004', '3010', '3011', '2001W', '3012') THEN 'SU'
	 WHEN STORE_CODE IN ('2223') THEN 'DS'
	 ELSE BUSINESS_UNIT END AS BUSINESS_UNIT, 
...
SUM(TARGET_SALE_VAL) TARGET_SALE_VAL, SUM(NET_SALE_TY) NET_SALE_TY, SUM(NET_SALE_LY) NET_SALE_LY, SUM(MTD_TARGET_SALE_VAL) MTD_TARGET_SALE_VAL, SUM(MTD_NET_SALE_TY) MTD_NET_SALE_TY, SUM(MTD_NET_SALE_LY) MTD_NET_SALE_LY, SUM(QTD_TARGET_SALE_VAL) QTD_TARGET_SALE_VAL, SUM(QTD_NET_SALE_TY) QTD_NET_SALE_TY, SUM(QTD_NET_SALE_LY) QTD_NET_SALE_LY 
FROM (
...
, SUM(NVL(WTD.TARGET_SALE_VAL,0)+NVL(WTD.NET_SALE_TY,0)+NVL(WTD.NET_SALE_LY,0)+NVL(MTD.TARGET_SALE_VAL,0)+NVL(MTD.NET_SALE_TY,0)+NVL(MTD.NET_SALE_LY,0)+NVL(QTD.TARGET_SALE_VAL,0)+NVL(QTD.NET_SALE_TY,0)+NVL(QTD.NET_SALE_LY,0)) SALE_CHECK
FROM
(SELECT S.STORE_KEY, S.STORE_FORMAT, S.STORE_FORMAT_DESC, 
	CASE WHEN S.STORE_CODE IN ('4002') THEN '2001W'
		...
		UPPER(S.STORE_DESCRIPTION) AS STORE_DESCRIPTION, BUSINESS_UNIT,
...
FROM
	(SELECT S.STORE_KEY, S.STORE_FORMAT, S.STORE_FORMAT_DESC, S.STORE_CODE, S.STORE_DESCRIPTION, S.NEW_FLG, S.MATURED_FLG, B.BUSINESS_UNIT FROM
		...
		(SELECT 'DS' AS BUSINESS_UNIT FROM DUAL UNION ALL SELECT 'SU' AS BUSINESS_UNIT FROM DUAL UNION ALL SELECT 'OT' AS BUSINESS_UNIT FROM DUAL)B
	GROUP BY S.STORE_KEY, S.STORE_FORMAT, S.STORE_FORMAT_DESC, S.STORE_CODE, S.STORE_DESCRIPTION, S.NEW_FLG, S.MATURED_FLG, B.BUSINESS_UNIT)S,
...
GROUP BY S.STORE_KEY, S.STORE_FORMAT, S.STORE_FORMAT_DESC, 
	CASE WHEN S.STORE_CODE IN ('4002') THEN '2001W'
		...
		UPPER(S.STORE_DESCRIPTION), BUSINESS_UNIT,
...
FROM (	
	SELECT TBL.STORE_KEY, TBL.STORE_CODE, TBL.BUSINESS_UNIT, TBL.DS_KEY, 
		TY.SALE_NET_VAL, TY.SALE_TOT_TAX_VAL, TY.SALE_TOT_DISC_VAL, 
		LY.SALE_NET_VAL AS SALE_NET_VAL_LY, LY.SALE_TOT_TAX_VAL AS SALE_TOT_TAX_VAL_LY, LY.SALE_TOT_DISC_VAL AS SALE_TOT_DISC_VAL_LY
	FROM
	(SELECT S.STORE_KEY, S.STORE_CODE, S.BUSINESS_UNIT, M.DS_KEY
	FROM
		(SELECT S.STORE_KEY, S.STORE_CODE, B.BUSINESS_UNIT FROM
			(SELECT STORE_KEY, STORE_CODE
			FROM DIM_STORE
			WHERE ACTIVE = 1 AND STORE_FORMAT IN (1, 2, 3, 4, 5)
			GROUP BY STORE_KEY, STORE_CODE)S,
			(SELECT 'DS' AS BUSINESS_UNIT FROM DUAL UNION ALL SELECT 'SU' AS BUSINESS_UNIT FROM DUAL UNION ALL SELECT 'OT' AS BUSINESS_UNIT FROM DUAL)B
			GROUP BY S.STORE_KEY, S.STORE_CODE, B.BUSINESS_UNIT)S,
	...
	GROUP BY S.STORE_KEY, S.STORE_CODE, S.BUSINESS_UNIT, M.DS_KEY)TBL
	LEFT JOIN
	(SELECT S.STORE_KEY,
		FL.STORE_CODE,
		CASE WHEN R.BUSINESS_UNIT IS NULL THEN SD.MERCH_GROUP_CODE
			WHEN R.BUSINESS_UNIT IN ('CS Store Credit', 'Credit POS') THEN SD.MERCH_GROUP_CODE
			WHEN R.BUSINESS_UNIT = 'SM' THEN 'SU'
			ELSE R.BUSINESS_UNIT END AS BUSINESS_UNIT, 
		SD.DS_KEY,
	  ...
	  FROM FCT_SALE_LINE FL
		JOIN FCT_SALE_HEADER FH ON FL.DATE_KEY = FH.DATE_KEY AND FL.DATE_KEY BETWEEN  $wk_st_date_key AND $wk_en_date_key AND FL.INVOICE_NO = FH.INVOICE_NO AND FL.STORE_CODE = FH.STORE_CODE
		JOIN DIM_DATE D ON FL.DATE_KEY = D.DATE_KEY
		JOIN DIM_STORE S ON FL.STORE_CODE   = S.STORE_CODE AND  S.VALID_FROM <= D.DATE_FLD AND  S.VALID_TO > D.DATE_FLD
		JOIN DIM_PRODUCT P ON FL.PRODUCT_CODE = P.PRODUCT_CODE  AND  P.VALID_FROM <= D.DATE_FLD AND  P.VALID_TO > D.DATE_FLD
		JOIN DIM_SUB_DEPT SD ON P.MERCH_GROUP_CODE = SD.MERCH_GROUP_CODE AND P.GROUP_CODE = SD.GROUP_CODE AND P.GROUP2_CODE = SD.GROUP2_CODE AND P.DIVISION = SD.DIVISION AND P.DEPARTMENT_CODE = SD.DEPARTMENT_CODE AND P.SUB_DEPARTMENT_CODE = SD.SUB_DEPARTMENT_CODE 
		JOIN DIM_TILL_STR T ON FL.TILL_KEY = T.TILL_KEY 
		LEFT JOIN METRO_IT_POS R ON T.STORE_CODE = R.RESA_STORE_CODE AND T.TILL_CODE = R.POS_NUMBER 
	  ...
	  GROUP BY 
		...
		CASE WHEN R.BUSINESS_UNIT IS NULL THEN SD.MERCH_GROUP_CODE
			WHEN R.BUSINESS_UNIT IN ('CS Store Credit', 'Credit POS') THEN SD.MERCH_GROUP_CODE
			WHEN R.BUSINESS_UNIT = 'SM' THEN 'SU'
			ELSE R.BUSINESS_UNIT END,
		SD.DS_KEY)TY
	ON TBL.STORE_KEY = TY.STORE_KEY AND TBL.STORE_CODE = TY.STORE_CODE AND TBL.BUSINESS_UNIT = TY.BUSINESS_UNIT AND TBL.DS_KEY = TY.DS_KEY
	LEFT JOIN
	(SELECT S.STORE_KEY,
		FL.STORE_CODE,
		CASE WHEN R.BUSINESS_UNIT IS NULL THEN SD.MERCH_GROUP_CODE
		...
		SUM(CASE WHEN FH.SALE_INVC_TYPE IN ('SALE','RETURN') AND FH.SALE_INVC_SUB_TYPE IN ('SALE','LAYCMP','RETURN') THEN FL.SALE_TOT_TAX_VAL END) AS SALE_TOT_TAX_VAL       
	  FROM FCT_SALE_LINE FL
		JOIN FCT_SALE_HEADER FH ON FL.DATE_KEY = FH.DATE_KEY AND FL.DATE_KEY BETWEEN  $wk_st_date_key_ly AND $wk_en_date_key_ly AND FL.INVOICE_NO = FH.INVOICE_NO AND FL.STORE_CODE = FH.STORE_CODE
		JOIN DIM_DATE D ON FL.DATE_KEY = D.DATE_KEY
		JOIN DIM_STORE S ON FL.STORE_CODE   = S.STORE_CODE AND  S.VALID_FROM <= D.DATE_FLD AND  S.VALID_TO > D.DATE_FLD
		JOIN DIM_PRODUCT P ON FL.PRODUCT_CODE = P.PRODUCT_CODE  AND  P.VALID_FROM <= D.DATE_FLD AND  P.VALID_TO > D.DATE_FLD
		JOIN DIM_SUB_DEPT SD ON P.MERCH_GROUP_CODE = SD.MERCH_GROUP_CODE AND P.GROUP_CODE = SD.GROUP_CODE AND P.GROUP2_CODE = SD.GROUP2_CODE AND P.DIVISION = SD.DIVISION AND P.DEPARTMENT_CODE = SD.DEPARTMENT_CODE AND P.SUB_DEPARTMENT_CODE = SD.SUB_DEPARTMENT_CODE 
	  ...
	  GROUP BY 
		...
		CASE WHEN R.BUSINESS_UNIT IS NULL THEN SD.MERCH_GROUP_CODE
			...
			ELSE R.BUSINESS_UNIT END,
		SD.DS_KEY)LY
	ON TBL.STORE_KEY = LY.STORE_KEY AND TBL.STORE_CODE = LY.STORE_CODE AND TBL.BUSINESS_UNIT = LY.BUSINESS_UNIT AND TBL.DS_KEY = LY.DS_KEY
...
GROUP BY DIM_STORE.STORE_KEY, DIM_STORE.STORE_FORMAT, BUSINESS_UNIT,
	CASE WHEN DIM_STORE.STORE_CODE IN ('4002') THEN '2001W'
...
ON BASE.STORE_KEY = WTD.STORE_KEY AND BASE.STORE_FORMAT = WTD.STORE_FORMAT AND BASE.STORE_CODE = WTD.STORE_CODE AND BASE.BUSINESS_UNIT = WTD.BUSINESS_UNIT AND BASE.MERCH_GROUP_CODE = WTD.MERCH_GROUP_CODE AND BASE.GROUP_CODE = WTD.GROUP_CODE AND BASE.DIVISION = WTD.DIVISION AND BASE.DEPARTMENT_CODE = WTD.DEPARTMENT_CODE
LEFT JOIN
(SELECT DIM_STORE.STORE_KEY, 
DIM_STORE.STORE_FORMAT, 
BUSINESS_UNIT,
...
FROM (	
	...
	(SELECT S.STORE_KEY,
		...
		SUM(CASE WHEN FH.SALE_INVC_TYPE IN ('SALE','RETURN') AND FH.SALE_INVC_SUB_TYPE IN ('SALE','LAYCMP','RETURN') THEN FL.SALE_TOT_TAX_VAL END) AS SALE_TOT_TAX_VAL       
	  FROM FCT_SALE_LINE FL
		JOIN FCT_SALE_HEADER FH ON FL.DATE_KEY = FH.DATE_KEY AND FL.DATE_KEY BETWEEN  $mo_st_date_key AND $mo_en_date_key AND FL.INVOICE_NO = FH.INVOICE_NO AND FL.STORE_CODE = FH.STORE_CODE
		JOIN DIM_DATE D ON FL.DATE_KEY = D.DATE_KEY
		JOIN DIM_STORE S ON FL.STORE_CODE   = S.STORE_CODE AND  S.VALID_FROM <= D.DATE_FLD AND  S.VALID_TO > D.DATE_FLD
		JOIN DIM_PRODUCT P ON FL.PRODUCT_CODE = P.PRODUCT_CODE  AND  P.VALID_FROM <= D.DATE_FLD AND  P.VALID_TO > D.DATE_FLD
		JOIN DIM_SUB_DEPT SD ON P.MERCH_GROUP_CODE = SD.MERCH_GROUP_CODE AND P.GROUP_CODE = SD.GROUP_CODE AND P.GROUP2_CODE = SD.GROUP2_CODE AND P.DIVISION = SD.DIVISION AND P.DEPARTMENT_CODE = SD.DEPARTMENT_CODE AND P.SUB_DEPARTMENT_CODE = SD.SUB_DEPARTMENT_CODE 
	...
	(SELECT S.STORE_KEY,
		...
		SUM(CASE WHEN FH.SALE_INVC_TYPE IN ('SALE','RETURN') AND FH.SALE_INVC_SUB_TYPE IN ('SALE','LAYCMP','RETURN') THEN FL.SALE_TOT_TAX_VAL END) AS SALE_TOT_TAX_VAL       
	  FROM FCT_SALE_LINE FL
		JOIN FCT_SALE_HEADER FH ON FL.DATE_KEY = FH.DATE_KEY AND FL.DATE_KEY BETWEEN  $mo_st_date_key_ly AND $mo_en_date_key_ly AND FL.INVOICE_NO = FH.INVOICE_NO AND FL.STORE_CODE = FH.STORE_CODE
		JOIN DIM_DATE D ON FL.DATE_KEY = D.DATE_KEY
		JOIN DIM_STORE S ON FL.STORE_CODE   = S.STORE_CODE AND  S.VALID_FROM <= D.DATE_FLD AND  S.VALID_TO > D.DATE_FLD
		JOIN DIM_PRODUCT P ON FL.PRODUCT_CODE = P.PRODUCT_CODE  AND  P.VALID_FROM <= D.DATE_FLD AND  P.VALID_TO > D.DATE_FLD
		JOIN DIM_SUB_DEPT SD ON P.MERCH_GROUP_CODE = SD.MERCH_GROUP_CODE AND P.GROUP_CODE = SD.GROUP_CODE AND P.GROUP2_CODE = SD.GROUP2_CODE AND P.DIVISION = SD.DIVISION AND P.DEPARTMENT_CODE = SD.DEPARTMENT_CODE AND P.SUB_DEPARTMENT_CODE = SD.SUB_DEPARTMENT_CODE 
...
ON BASE.STORE_KEY = MTD.STORE_KEY AND BASE.STORE_FORMAT = MTD.STORE_FORMAT AND BASE.STORE_CODE = MTD.STORE_CODE AND BASE.BUSINESS_UNIT = MTD.BUSINESS_UNIT AND BASE.MERCH_GROUP_CODE = MTD.MERCH_GROUP_CODE AND BASE.GROUP_CODE = MTD.GROUP_CODE AND BASE.DIVISION = MTD.DIVISION AND BASE.DEPARTMENT_CODE = MTD.DEPARTMENT_CODE
LEFT JOIN
(SELECT DIM_STORE.STORE_KEY, 
DIM_STORE.STORE_FORMAT, 
BUSINESS_UNIT,
...
FROM (	
	...
	(SELECT S.STORE_KEY,
		...
		SUM(CASE WHEN FH.SALE_INVC_TYPE IN ('SALE','RETURN') AND FH.SALE_INVC_SUB_TYPE IN ('SALE','LAYCMP','RETURN') THEN FL.SALE_TOT_TAX_VAL END) AS SALE_TOT_TAX_VAL       
	  FROM FCT_SALE_LINE FL
		JOIN FCT_SALE_HEADER FH ON FL.DATE_KEY = FH.DATE_KEY AND FL.DATE_KEY BETWEEN  $qu_st_date_key AND $mo_en_date_key AND FL.INVOICE_NO = FH.INVOICE_NO AND FL.STORE_CODE = FH.STORE_CODE
		JOIN DIM_DATE D ON FL.DATE_KEY = D.DATE_KEY
		JOIN DIM_STORE S ON FL.STORE_CODE   = S.STORE_CODE AND  S.VALID_FROM <= D.DATE_FLD AND  S.VALID_TO > D.DATE_FLD
		JOIN DIM_PRODUCT P ON FL.PRODUCT_CODE = P.PRODUCT_CODE  AND  P.VALID_FROM <= D.DATE_FLD AND  P.VALID_TO > D.DATE_FLD
		JOIN DIM_SUB_DEPT SD ON P.MERCH_GROUP_CODE = SD.MERCH_GROUP_CODE AND P.GROUP_CODE = SD.GROUP_CODE AND P.GROUP2_CODE = SD.GROUP2_CODE AND P.DIVISION = SD.DIVISION AND P.DEPARTMENT_CODE = SD.DEPARTMENT_CODE AND P.SUB_DEPARTMENT_CODE = SD.SUB_DEPARTMENT_CODE 
	...
	(SELECT S.STORE_KEY,
		...
		SUM(CASE WHEN FH.SALE_INVC_TYPE IN ('SALE','RETURN') AND FH.SALE_INVC_SUB_TYPE IN ('SALE','LAYCMP','RETURN') THEN FL.SALE_TOT_TAX_VAL END) AS SALE_TOT_TAX_VAL       
	  FROM FCT_SALE_LINE FL
		JOIN FCT_SALE_HEADER FH ON FL.DATE_KEY = FH.DATE_KEY AND FL.DATE_KEY BETWEEN  $qu_st_date_key_ly AND $mo_en_date_key_ly AND FL.INVOICE_NO = FH.INVOICE_NO AND FL.STORE_CODE = FH.STORE_CODE
		JOIN DIM_DATE D ON FL.DATE_KEY = D.DATE_KEY
		JOIN DIM_STORE S ON FL.STORE_CODE   = S.STORE_CODE AND  S.VALID_FROM <= D.DATE_FLD AND  S.VALID_TO > D.DATE_FLD
		JOIN DIM_PRODUCT P ON FL.PRODUCT_CODE = P.PRODUCT_CODE  AND  P.VALID_FROM <= D.DATE_FLD AND  P.VALID_TO > D.DATE_FLD
		JOIN DIM_SUB_DEPT SD ON P.MERCH_GROUP_CODE = SD.MERCH_GROUP_CODE AND P.GROUP_CODE = SD.GROUP_CODE AND P.GROUP2_CODE = SD.GROUP2_CODE AND P.DIVISION = SD.DIVISION AND P.DEPARTMENT_CODE = SD.DEPARTMENT_CODE AND P.SUB_DEPARTMENT_CODE = SD.SUB_DEPARTMENT_CODE 
...
ON BASE.STORE_KEY = QTD.STORE_KEY AND BASE.STORE_FORMAT = QTD.STORE_FORMAT AND BASE.STORE_CODE = QTD.STORE_CODE AND BASE.BUSINESS_UNIT = QTD.BUSINESS_UNIT AND BASE.MERCH_GROUP_CODE = QTD.MERCH_GROUP_CODE AND BASE.GROUP_CODE = QTD.GROUP_CODE AND BASE.DIVISION = QTD.DIVISION AND BASE.DEPARTMENT_CODE = QTD.DEPARTMENT_CODE
GROUP BY
BASE.STORE_FORMAT, 
BASE.STORE_FORMAT_DESC, 
BASE.STORE_CODE, 
...
WHERE SALE_CHECK <> 0
GROUP BY STORE_FORMAT, STORE_FORMAT_DESC, STORE_CODE, STORE, STORE_DESCRIPTION, 
CASE WHEN STORE_CODE IN ('2012', '2013', '3009', '4004', '3010', '3011', '2001W', '3012') THEN 'SU'
	 WHEN STORE_CODE IN ('2223') THEN 'DS'
...
my $sth = $dbh->prepare ($test);
 ...
 close $fh or die "bi_sales_perf_17.csv: $!";
...
#$to = ' gerry.guanlao@metrogaisano.com, eric.redona@metrogaisano.com, lucille.malazarte@metrogaisano.com, tricia.luntao@metrogaisano.com, jj.moreno@metrogaisano.com, rose.jose@metrogaisano.com, rex.cabanilla@metrogaisano.com  ';

#$to = ' kent.mamalias@metrogaisano.com, lea.gonzaga@metrogaisano.com, annalyn.conde@metrogaisano.com, fnaquines@metro.com.ph, cham.burgos@metrogaisano.com ';
$to = 'lea.gonzaga@metrogaisano.com,annalyn.conde@metrogaisano.com, cham.burgos@metrogaisano.com ';

$from = 'Report Mailer<report.mailer@metrogaisano.com>';

$subject = 'Daily Sales Performance(Double Display) as of ' . $as_of;

$msgbody_file = 'message_BI.txt';

$attachment_file_1 = "Daily Sales Performance - Summary-DoubleDisplay (as of $as_of) v1.7.xlsx";
