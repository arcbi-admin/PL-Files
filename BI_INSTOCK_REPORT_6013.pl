...
FROM
	...
	FROM(
		...
		WHERE LOC.STATUS IN ('A') AND  REPL.ACTIVATE_DATE <= SYSDATE AND (REPL.DEACTIVATE_DATE IS NULL OR REPL.DEACTIVATE_DATE > SYSDATE) AND DEPS.PURCHASE_TYPE = 0
		)TBL
	--WHERE AUTO_REP = 'Y'
...
#$to = ' may.sasedor@metrogaisano.com, donna.fernando@metrogaisano.com, victoria.ferolino@metrogaisano.com, wendel.gallo@metrogaisano.com, ronald.dizon@metrogaisano.com, alexander.tejedor@metrogaisano.com, emily.silverio@metrogaisano.com, chit.lazaro@metrogaisano.com, jocelyn.sarmiento@metrogaisano.com, charisse.mancao@metrogaisano.com, cindy.yu@metrogaisano.com, cresilda.dehayco@metrogaisano.com, evan.inocencio@metrogaisano.com, fe.botero@metrogaisano.com, jonrel.nacor@metrogaisano.com, judith.tud@metrogaisano.com, junah.oliveron@metrogaisano.com, lyn.cabatuan@metrogaisano.com, zenda.mangabon@metrogaisano.com, joyce.mirabueno@metrogaisano.com, marygrace.ong@metrogaisano.com, rowena.tangoan@metrogaisano.com, genevive.quinones@metrogaisano.com, angeli_cristi.ladot@metrogaisano.com, edris.tarrobal@metrogaisano.com, charmaine.buenaventura@metrogaisano.com, augosto.daria@metrogaisano.com, cj.jesena@metrogaisano.com, gerry.guanlao@metrogaisano.com ';

#$cc = 'cherry.gulloy@metrogaisano.com, janice.bedrijo@metrogaisano.com, jerson.roma@metrogaisano.com, bermon.alcantara@metrogaisano.com, eljie.laquinon@metrogaisano.com, nilynn.yosores@metrogaisano.com, ryanneil.dupay@metrogaisano.com, anafatima.mancho@metrogaisano.com, opcplanning@metrogaisano.com, kristine.apurado@metrogaisano.com, bebelyn.cabasan@metrogaisano.com';
